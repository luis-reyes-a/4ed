...
defcolor_bar_active = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("defcolor_bar_active"));
...
view_prev_mark_pos_before_snap_to_cursor = managed_id_declare(app, string_u8_litexpr("attachment"), string_u8_litexpr("view_prev_mark_pos_before_snap_to_cursor"));
...
luiscolor_variable_decl = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("luiscolor_variable_decl"));
luiscolor_modal_cursor = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("luiscolor_modal_cursor"));
luiscolor_tab_current = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("luiscolor_tab_current"));
luiscolor_tab_regular = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("luiscolor_tab_regular"));
luiscolor_logical_not = managed_id_declare(app, string_u8_litexpr("colors"), string_u8_litexpr("luiscolor_logical_not"));
}
