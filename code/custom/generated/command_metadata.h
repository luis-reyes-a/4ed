...
#define command_one_past_last_id 307
...
static Command_Metadata fcoder_metacmd_table[307] = {
...
{ PROC_LINKS(center_view, 0), false, "center_view", 11, "Centers the view vertically on the line on which the cursor sits.", 65, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 197 },
...
{ PROC_LINKS(clean_all_lines, 0), false, "clean_all_lines", 15, "Removes trailing whitespace from all lines and removes all blank lines in the current buffer.", 93, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 648 },
{ PROC_LINKS(clean_trailing_whitespace, 0), false, "clean_trailing_whitespace", 25, "Removes trailing whitespace from all lines in the current buffer.", 65, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 657 },
...
{ PROC_LINKS(click_set_cursor, 0), false, "click_set_cursor", 16, "Sets the cursor position to the mouse position.", 47, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 235 },
{ PROC_LINKS(click_set_cursor_and_mark, 0), false, "click_set_cursor_and_mark", 25, "Sets the cursor position and mark to the mouse position.", 56, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 225 },
{ PROC_LINKS(click_set_cursor_if_lbutton, 0), false, "click_set_cursor_if_lbutton", 27, "If the mouse left button is pressed, sets the cursor position to the mouse position.", 84, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 245 },
{ PROC_LINKS(click_set_mark, 0), false, "click_set_mark", 14, "Sets the mark position to the mouse position.", 45, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 258 },
...
{ PROC_LINKS(close_panel, 0), false, "close_panel", 11, "Closes the currently active panel if it is not the only panel open.", 67, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 676 },
...
{ PROC_LINKS(cursor_mark_swap, 0), false, "cursor_mark_swap", 16, "Swaps the position of the cursor and the mark.", 46, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 124 },
...
{ PROC_LINKS(decrease_face_size, 0), false, "decrease_face_size", 18, "Decrease the size of the face used by the current buffer.", 57, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 759 },
{ PROC_LINKS(default_file_externally_modified, 0), false, "default_file_externally_modified", 32, "Notes the external modification of attached files by printing a message.", 72, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 2067 },
...
{ PROC_LINKS(delete_alpha_numeric_boundary, 0), false, "delete_alpha_numeric_boundary", 29, "Delete characters between the cursor position and the first alphanumeric boundary to the right.", 95, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 162 },
{ PROC_LINKS(delete_char, 0), false, "delete_char", 11, "Deletes the character to the right of the cursor.", 49, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 79 },
...
{ PROC_LINKS(delete_file_query, 0), false, "delete_file_query", 17, "Deletes the file of the current buffer if 4coder has the appropriate access rights. Will ask the user for confirmation first.", 125, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1385 },
{ PROC_LINKS(delete_line, 0), false, "delete_line", 11, "Delete the line the on which the cursor sits.", 45, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1557 },
{ PROC_LINKS(delete_range, 0), false, "delete_range", 12, "Deletes the text in the range between the cursor and the mark.", 62, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 134 },
...
{ PROC_LINKS(duplicate_line, 0), false, "duplicate_line", 14, "Create a copy of the line on which the cursor sits.", 51, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1543 },
...
{ PROC_LINKS(exit_4coder, 0), false, "exit_4coder", 11, "Attempts to close 4coder.", 25, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 848 },
{ PROC_LINKS(explorer, 0), false, "explorer", 8, "Opens file explorer in hot directory", 36, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3 },
...
{ PROC_LINKS(goto_beginning_of_file, 0), false, "goto_beginning_of_file", 22, "Sets the cursor to the beginning of the file.", 45, "D:\\work\\4ed\\code\\custom\\4coder_helper.cpp", 41, 2258 },
{ PROC_LINKS(goto_end_of_file, 0), false, "goto_end_of_file", 16, "Sets the cursor to the end of the file.", 39, "D:\\work\\4ed\\code\\custom\\4coder_helper.cpp", 41, 2266 },
...
{ PROC_LINKS(goto_line, 0), false, "goto_line", 9, "Queries the user for a number, and jumps the cursor to the corresponding line.", 78, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 856 },
...
{ PROC_LINKS(hide_filebar, 0), false, "hide_filebar", 12, "Sets the current view to hide it's filebar.", 43, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 706 },
{ PROC_LINKS(hide_scrollbar, 0), false, "hide_scrollbar", 14, "Sets the current view to hide it's scrollbar.", 45, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 692 },
...
{ PROC_LINKS(increase_face_size, 0), false, "increase_face_size", 18, "Increase the size of the face used by the current buffer.", 57, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 748 },
...
{ PROC_LINKS(jump_to_last_point, 0), false, "jump_to_last_point", 18, "Read from the top of the point stack and jump there; if already there pop the top and go to the next option", 107, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1338 },
...
{ PROC_LINKS(kill_buffer, 0), false, "kill_buffer", 11, "Kills the current buffer.", 25, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1728 },
...
{ PROC_LINKS(left_adjust_view, 0), false, "left_adjust_view", 16, "Sets the left size of the view near the x position of the cursor.", 65, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 212 },
...
{ PROC_LINKS(list_all_locations, 0), false, "list_all_locations", 18, "Queries the user for a string and lists all exact case-sensitive matches found in all open buffers.", 99, "D:\\work\\4ed\\code\\custom\\4coder_search.cpp", 41, 168 },
{ PROC_LINKS(list_all_locations_case_insensitive, 0), false, "list_all_locations_case_insensitive", 35, "Queries the user for a string and lists all exact case-insensitive matches found in all open buffers.", 101, "D:\\work\\4ed\\code\\custom\\4coder_search.cpp", 41, 180 },
{ PROC_LINKS(list_all_locations_of_identifier, 0), false, "list_all_locations_of_identifier", 32, "Reads a token or word under the cursor and lists all exact case-sensitive mathces in all open buffers.", 102, "D:\\work\\4ed\\code\\custom\\4coder_search.cpp", 41, 192 },
{ PROC_LINKS(list_all_locations_of_identifier_case_insensitive, 0), false, "list_all_locations_of_identifier_case_insensitive", 49, "Reads a token or word under the cursor and lists all exact case-insensitive mathces in all open buffers.", 104, "D:\\work\\4ed\\code\\custom\\4coder_search.cpp", 41, 198 },
{ PROC_LINKS(list_all_locations_of_selection, 0), false, "list_all_locations_of_selection", 31, "Reads the string in the selected range and lists all exact case-sensitive mathces in all open buffers.", 102, "D:\\work\\4ed\\code\\custom\\4coder_search.cpp", 41, 204 },
{ PROC_LINKS(list_all_locations_of_selection_case_insensitive, 0), false, "list_all_locations_of_selection_case_insensitive", 48, "Reads the string in the selected range and lists all exact case-insensitive mathces in all open buffers.", 104, "D:\\work\\4ed\\code\\custom\\4coder_search.cpp", 41, 210 },
{ PROC_LINKS(list_all_locations_of_type_definition, 0), false, "list_all_locations_of_type_definition", 37, "Queries user for string, lists all locations of strings that appear to define a type whose name matches the input string.", 121, "D:\\work\\4ed\\code\\custom\\4coder_search.cpp", 41, 216 },
{ PROC_LINKS(list_all_locations_of_type_definition_of_identifier, 0), false, "list_all_locations_of_type_definition_of_identifier", 51, "Reads a token or word under the cursor and lists all locations of strings that appear to define a type whose name matches it.", 125, "D:\\work\\4ed\\code\\custom\\4coder_search.cpp", 41, 224 },
{ PROC_LINKS(list_all_substring_locations, 0), false, "list_all_substring_locations", 28, "Queries the user for a string and lists all case-sensitive substring matches found in all open buffers.", 103, "D:\\work\\4ed\\code\\custom\\4coder_search.cpp", 41, 174 },
{ PROC_LINKS(list_all_substring_locations_case_insensitive, 0), false, "list_all_substring_locations_case_insensitive", 45, "Queries the user for a string and lists all case-insensitive substring matches found in all open buffers.", 105, "D:\\work\\4ed\\code\\custom\\4coder_search.cpp", 41, 186 },
...
{ PROC_LINKS(luis_adjust_horizontal_view_toggle, 0), false, "luis_adjust_horizontal_view_toggle", 34, "Moves view horizontally to cursor x pos or back to leftmost of screen", 69, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 240 },
{ PROC_LINKS(luis_build, 0), false, "luis_build", 10, "build", 5, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 460 },
{ PROC_LINKS(luis_center_view_top, 0), false, "luis_center_view_top", 20, "Centers the view vertically on the line on which the cursor sits.", 65, "D:\\work\\4ed\\code\\custom\\luis_custom_layer.h", 43, 308 },
{ PROC_LINKS(luis_close_panel, 0), false, "luis_close_panel", 16, "Close panel. Peek first.", 24, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 353 },
{ PROC_LINKS(luis_code_index_next, 0), false, "luis_code_index_next", 20, "prev code index", 15, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1042 },
{ PROC_LINKS(luis_code_index_prev, 0), false, "luis_code_index_prev", 20, "prev code index", 15, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1021 },
{ PROC_LINKS(luis_end, 0), false, "luis_end", 8, "go end of visual line", 21, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 312 },
{ PROC_LINKS(luis_escape, 0), false, "luis_escape", 11, "escape key", 10, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 11 },
{ PROC_LINKS(luis_fsearch, 0), false, "luis_fsearch", 12, "search forwards", 15, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1309 },
{ PROC_LINKS(luis_home, 0), false, "luis_home", 9, "go start of visual line", 23, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 53 },
{ PROC_LINKS(luis_indent_range, 0), false, "luis_indent_range", 17, "indent_range", 12, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 155 },
{ PROC_LINKS(luis_interactive_open_or_new, 0), false, "luis_interactive_open_or_new", 28, "open in new in same tab", 23, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 27 },
{ PROC_LINKS(luis_left_word, 0), false, "luis_left_word", 14, "move left", 9, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 62 },
{ PROC_LINKS(luis_list_nests_this_buffer, 0), false, "luis_list_nests_this_buffer", 27, "Show code nests for this buffer", 31, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 558 },
{ PROC_LINKS(luis_list_notes_this_buffer, 0), false, "luis_list_notes_this_buffer", 27, "Show code indexes for buffer", 28, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 599 },
{ PROC_LINKS(luis_matching_file_cpp, 0), false, "luis_matching_file_cpp", 22, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 425 },
{ PROC_LINKS(luis_matching_file_cpp_same_buffer, 0), false, "luis_matching_file_cpp_same_buffer", 34, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 415 },
{ PROC_LINKS(luis_multiline_comment_toggle, 0), false, "luis_multiline_comment_toggle", 29, "Deletes all whitespace at cursor, going backwards", 49, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 263 },
{ PROC_LINKS(luis_return, 0), false, "luis_return", 11, "If the buffer in the active view is writable, inserts a character, otherwise performs goto_jump_at_cursor.", 106, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 437 },
{ PROC_LINKS(luis_right_word, 0), false, "luis_right_word", 15, "move right", 10, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 69 },
{ PROC_LINKS(luis_rsearch, 0), false, "luis_rsearch", 12, "search backwards", 16, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1316 },
{ PROC_LINKS(luis_scope_braces, 0), false, "luis_scope_braces", 17, "writes {}", 9, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 106 },
{ PROC_LINKS(luis_select_line, 0), false, "luis_select_line", 16, "go end of visual line", 21, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 172 },
{ PROC_LINKS(luis_select_surrounding_scope, 0), false, "luis_select_surrounding_scope", 29, "select surrounding scope", 24, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 190 },
{ PROC_LINKS(luis_select_surrounding_scope_maximal, 0), false, "luis_select_surrounding_scope_maximal", 37, "select surrounding scope", 24, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 202 },
{ PROC_LINKS(luis_set_mark, 0), false, "luis_set_mark", 13, "set mark", 8, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 84 },
{ PROC_LINKS(luis_toggle_modal_mode, 0), false, "luis_toggle_modal_mode", 22, "Toggles modal mode", 18, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 17 },
{ PROC_LINKS(luis_view_input_handler, 0), false, "luis_view_input_handler", 23, "Input consumption loop for default view behavior", 48, "D:\\work\\4ed\\code\\custom\\luis_hooks.cpp", 38, 3 },
{ PROC_LINKS(luis_write_newline, 0), false, "luis_write_newline", 18, "", 0, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 229 },
{ PROC_LINKS(luis_write_pointer_arrow, 0), false, "luis_write_pointer_arrow", 24, "", 0, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 225 },
{ PROC_LINKS(luis_write_tab, 0), false, "luis_write_tab", 14, "", 0, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 233 },
{ PROC_LINKS(luis_write_underscore, 0), false, "luis_write_underscore", 21, "", 0, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 221 },
{ PROC_LINKS(make_directory_query, 0), false, "make_directory_query", 20, "Queries the user for a name and creates a new directory with the given name.", 76, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1497 },
...
{ PROC_LINKS(mouse_wheel_change_face_size, 0), false, "mouse_wheel_change_face_size", 28, "Reads the state of the mouse wheel and uses it to either increase or decrease the face size.", 92, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 801 },
{ PROC_LINKS(mouse_wheel_scroll, 0), false, "mouse_wheel_scroll", 18, "Reads the scroll wheel value from the mouse state and scrolls accordingly.", 74, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 268 },
{ PROC_LINKS(move_down, 0), false, "move_down", 9, "Moves the cursor down one line.", 31, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 342 },
{ PROC_LINKS(move_down_10, 0), false, "move_down_10", 12, "Moves the cursor down ten lines.", 32, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 354 },
{ PROC_LINKS(move_down_textual, 0), false, "move_down_textual", 17, "Moves down to the next line of actual text, regardless of line wrapping.", 72, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 360 },
{ PROC_LINKS(move_down_to_blank_line, 0), false, "move_down_to_blank_line", 23, "Seeks the cursor down to the next blank line.", 45, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 413 },
{ PROC_LINKS(move_down_to_blank_line_end, 0), false, "move_down_to_blank_line_end", 27, "Seeks the cursor down to the next blank line and places it at the end of the line.", 82, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 437 },
{ PROC_LINKS(move_down_to_blank_line_skip_whitespace, 0), false, "move_down_to_blank_line_skip_whitespace", 39, "Seeks the cursor down to the next blank line and places it at the end of the line.", 82, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 425 },
{ PROC_LINKS(move_left, 0), false, "move_left", 9, "Moves the cursor one character to the left.", 43, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 443 },
{ PROC_LINKS(move_left_alpha_numeric_boundary, 0), false, "move_left_alpha_numeric_boundary", 32, "Seek left for boundary between alphanumeric characters and non-alphanumeric characters.", 87, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 520 },
{ PROC_LINKS(move_left_alpha_numeric_or_camel_boundary, 0), false, "move_left_alpha_numeric_or_camel_boundary", 41, "Seek left for boundary between alphanumeric characters or camel case word and non-alphanumeric characters.", 106, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 534 },
{ PROC_LINKS(move_left_token_boundary, 0), false, "move_left_token_boundary", 24, "Seek left for the next beginning of a token.", 44, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 492 },
{ PROC_LINKS(move_left_whitespace_boundary, 0), false, "move_left_whitespace_boundary", 29, "Seek left for the next boundary between whitespace and non-whitespace.", 70, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 477 },
{ PROC_LINKS(move_left_whitespace_or_token_boundary, 0), false, "move_left_whitespace_or_token_boundary", 38, "Seek left for the next end of a token or boundary between whitespace and non-whitespace.", 88, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 506 },
{ PROC_LINKS(move_line_down, 0), false, "move_line_down", 14, "Swaps the line under the cursor with the line below it, and moves the cursor down with it.", 90, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1537 },
{ PROC_LINKS(move_line_up, 0), false, "move_line_up", 12, "Swaps the line under the cursor with the line above it, and moves the cursor up with it.", 88, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1531 },
{ PROC_LINKS(move_right, 0), false, "move_right", 10, "Moves the cursor one character to the right.", 44, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 451 },
{ PROC_LINKS(move_right_alpha_numeric_boundary, 0), false, "move_right_alpha_numeric_boundary", 33, "Seek right for boundary between alphanumeric characters and non-alphanumeric characters.", 88, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 513 },
{ PROC_LINKS(move_right_alpha_numeric_or_camel_boundary, 0), false, "move_right_alpha_numeric_or_camel_boundary", 42, "Seek right for boundary between alphanumeric characters or camel case word and non-alphanumeric characters.", 107, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 527 },
{ PROC_LINKS(move_right_token_boundary, 0), false, "move_right_token_boundary", 25, "Seek right for the next end of a token.", 39, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 485 },
{ PROC_LINKS(move_right_whitespace_boundary, 0), false, "move_right_whitespace_boundary", 30, "Seek right for the next boundary between whitespace and non-whitespace.", 71, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 469 },
{ PROC_LINKS(move_right_whitespace_or_token_boundary, 0), false, "move_right_whitespace_or_token_boundary", 39, "Seek right for the next end of a token or boundary between whitespace and non-whitespace.", 89, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 499 },
{ PROC_LINKS(move_up, 0), false, "move_up", 7, "Moves the cursor up one line.", 29, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 336 },
{ PROC_LINKS(move_up_10, 0), false, "move_up_10", 10, "Moves the cursor up ten lines.", 30, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 348 },
{ PROC_LINKS(move_up_to_blank_line, 0), false, "move_up_to_blank_line", 21, "Seeks the cursor up to the next blank line.", 43, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 407 },
{ PROC_LINKS(move_up_to_blank_line_end, 0), false, "move_up_to_blank_line_end", 25, "Seeks the cursor up to the next blank line and places it at the end of the line.", 80, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 431 },
{ PROC_LINKS(move_up_to_blank_line_skip_whitespace, 0), false, "move_up_to_blank_line_skip_whitespace", 37, "Seeks the cursor up to the next blank line and places it at the end of the line.", 80, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 419 },
...
{ PROC_LINKS(open_file_in_quotes, 0), false, "open_file_in_quotes", 19, "Reads a filename from surrounding '\"' characters and attempts to open the corresponding file.", 94, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1578 },
{ PROC_LINKS(open_in_other, 0), false, "open_in_other", 13, "Interactively opens a file in the other panel.", 46, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 2061 },
...
{ PROC_LINKS(open_matching_file_cpp, 0), false, "open_matching_file_cpp", 22, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1661 },
...
{ PROC_LINKS(page_down, 0), false, "page_down", 9, "Scrolls the view down one view height and moves the cursor down one view height.", 80, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 378 },
{ PROC_LINKS(page_up, 0), false, "page_up", 7, "Scrolls the view up one view height and moves the cursor up one view height.", 76, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 370 },
...
{ PROC_LINKS(query_replace, 0), false, "query_replace", 13, "Queries the user for two strings, and incrementally replaces every occurence of the first string with the second string.", 120, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1284 },
{ PROC_LINKS(query_replace_identifier, 0), false, "query_replace_identifier", 24, "Queries the user for a string, and incrementally replace every occurence of the word or token found at the cursor with the specified string.", 140, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1305 },
{ PROC_LINKS(query_replace_selection, 0), false, "query_replace_selection", 23, "Queries the user for a string, and incrementally replace every occurence of the string found in the selected range with the specified string.", 141, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1321 },
{ PROC_LINKS(quick_swap_buffer, 0), false, "quick_swap_buffer", 17, "Change to the most recently used buffer in this view - or to the top of the buffer stack if the most recent doesn't exist anymore", 129, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1708 },
{ PROC_LINKS(redo, 0), false, "redo", 4, "Advances forwards through the undo history of the current buffer.", 65, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1888 },
{ PROC_LINKS(redo_all_buffers, 0), false, "redo_all_buffers", 16, "Advances forward through the undo history in the buffer containing the most recent regular edit.", 96, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1985 },
{ PROC_LINKS(rename_file_query, 0), false, "rename_file_query", 17, "Queries the user for a new name and renames the file of the current buffer, altering the buffer's name too.", 107, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1462 },
{ PROC_LINKS(reopen, 0), false, "reopen", 6, "Reopen the current buffer from the hard drive.", 46, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1746 },
{ PROC_LINKS(replace_in_all_buffers, 0), false, "replace_in_all_buffers", 22, "Queries the user for a needle and string. Replaces all occurences of needle with string in all editable buffers.", 112, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1194 },
{ PROC_LINKS(replace_in_buffer, 0), false, "replace_in_buffer", 17, "Queries the user for a needle and string. Replaces all occurences of needle with string in the active buffer.", 109, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1185 },
{ PROC_LINKS(replace_in_range, 0), false, "replace_in_range", 16, "Queries the user for a needle and string. Replaces all occurences of needle with string in the range between cursor and the mark in the active buffer.", 150, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1176 },
{ PROC_LINKS(reverse_search, 0), false, "reverse_search", 14, "Begins an incremental search up through the current buffer for a user specified string.", 87, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1117 },
{ PROC_LINKS(reverse_search_identifier, 0), false, "reverse_search_identifier", 25, "Begins an incremental search up through the current buffer for the word or token under the cursor.", 98, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1129 },
{ PROC_LINKS(save, 0), false, "save", 4, "Saves the current buffer.", 25, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1736 },
...
{ PROC_LINKS(save_to_query, 0), false, "save_to_query", 13, "Queries the user for a file name and saves the contents of the current buffer, altering the buffer's name too.", 110, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1429 },
{ PROC_LINKS(search, 0), false, "search", 6, "Begins an incremental search down through the current buffer for a user specified string.", 89, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1111 },
{ PROC_LINKS(search_identifier, 0), false, "search_identifier", 17, "Begins an incremental search down through the current buffer for the word or token under the cursor.", 100, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1123 },
{ PROC_LINKS(seek_beginning_of_line, 0), false, "seek_beginning_of_line", 22, "Seeks the cursor to the beginning of the visual line.", 53, "D:\\work\\4ed\\code\\custom\\4coder_helper.cpp", 41, 2246 },
{ PROC_LINKS(seek_beginning_of_textual_line, 0), false, "seek_beginning_of_textual_line", 30, "Seeks the cursor to the beginning of the line across all text.", 62, "D:\\work\\4ed\\code\\custom\\4coder_helper.cpp", 41, 2234 },
{ PROC_LINKS(seek_end_of_line, 0), false, "seek_end_of_line", 16, "Seeks the cursor to the end of the visual line.", 47, "D:\\work\\4ed\\code\\custom\\4coder_helper.cpp", 41, 2252 },
{ PROC_LINKS(seek_end_of_textual_line, 0), false, "seek_end_of_textual_line", 24, "Seeks the cursor to the end of the line across all text.", 56, "D:\\work\\4ed\\code\\custom\\4coder_helper.cpp", 41, 2240 },
{ PROC_LINKS(select_all, 0), false, "select_all", 10, "Puts the cursor at the top of the file, and the mark at the bottom of the file.", 79, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 543 },
...
{ PROC_LINKS(set_face_size, 0), false, "set_face_size", 13, "Set face size of the face used by the current buffer.", 53, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 728 },
{ PROC_LINKS(set_face_size_this_buffer, 0), false, "set_face_size_this_buffer", 25, "Set face size of the face used by the current buffer; if any other buffers are using the same face a new face is created so that only this buffer is effected", 157, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 770 },
{ PROC_LINKS(set_mark, 0), false, "set_mark", 8, "Sets the mark to the current position of the cursor.", 52, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 115 },
...
{ PROC_LINKS(show_filebar, 0), false, "show_filebar", 12, "Sets the current view to show it's filebar.", 43, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 699 },
{ PROC_LINKS(show_scrollbar, 0), false, "show_scrollbar", 14, "Sets the current view to show it's scrollbar.", 45, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 685 },
...
{ PROC_LINKS(snipe_backward_whitespace_or_token_boundary, 0), false, "snipe_backward_whitespace_or_token_boundary", 43, "Delete a single, whole token on or to the left of the cursor and post it to the clipboard.", 90, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 179 },
{ PROC_LINKS(snipe_forward_whitespace_or_token_boundary, 0), false, "snipe_forward_whitespace_or_token_boundary", 42, "Delete a single, whole token on or to the right of the cursor and post it to the clipboard.", 91, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 187 },
...
{ PROC_LINKS(swap_panels, 0), false, "swap_panels", 11, "Swaps the active panel with it's sibling.", 41, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1686 },
...
{ PROC_LINKS(to_lowercase, 0), false, "to_lowercase", 12, "Converts all ascii text in the range between the cursor and the mark to lowercase.", 82, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 569 },
{ PROC_LINKS(to_uppercase, 0), false, "to_uppercase", 12, "Converts all ascii text in the range between the cursor and the mark to uppercase.", 82, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 556 },
{ PROC_LINKS(toggle_filebar, 0), false, "toggle_filebar", 14, "Toggles the visibility status of the current view's filebar.", 60, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 713 },
{ PROC_LINKS(toggle_fps_meter, 0), false, "toggle_fps_meter", 16, "Toggles the visibility of the FPS performance meter", 51, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 722 },
...
{ PROC_LINKS(toggle_line_numbers, 0), false, "toggle_line_numbers", 19, "Toggles the left margin line numbers.", 37, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 827 },
{ PROC_LINKS(toggle_line_wrap, 0), false, "toggle_line_wrap", 16, "Toggles the line wrap setting on this buffer.", 45, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 835 },
...
{ PROC_LINKS(toggle_show_whitespace, 0), false, "toggle_show_whitespace", 22, "Toggles the current buffer's whitespace visibility status.", 58, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 818 },
{ PROC_LINKS(toggle_virtual_whitespace, 0), false, "toggle_virtual_whitespace", 25, "Toggles virtual whitespace for all files.", 41, "D:\\work\\4ed\\code\\custom\\4coder_code_index.cpp", 45, 1663 },
...
{ PROC_LINKS(undo, 0), false, "undo", 4, "Advances backwards through the undo history of the current buffer.", 66, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1836 },
{ PROC_LINKS(undo_all_buffers, 0), false, "undo_all_buffers", 16, "Advances backward through the undo history in the buffer containing the most recent regular edit.", 97, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1914 },
{ PROC_LINKS(view_buffer_other_panel, 0), false, "view_buffer_other_panel", 23, "Set the other non-active panel to view the buffer that the active panel views, and switch to that panel.", 104, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1674 },
...
{ PROC_LINKS(vim_list_all_functions_current_buffer_lister, 0), true, "vim_list_all_functions_current_buffer_lister", 44, "Creates a lister of locations that look like function definitions and declarations in the buffer.", 97, "D:\\work\\4ed\\code\\custom\\4coder_vim_lists.cpp", 44, 367 },
{ PROC_LINKS(vim_proj_cmd_lister, 0), true, "vim_proj_cmd_lister", 19, "Opens an interactive list of all project commands.", 50, "D:\\work\\4ed\\code\\custom\\4coder_vim_lists.cpp", 44, 386 },
{ PROC_LINKS(vim_switch_lister, 0), true, "vim_switch_lister", 17, "Opens an interactive list of all loaded buffers.", 48, "D:\\work\\4ed\\code\\custom\\4coder_vim_lists.cpp", 44, 306 },
{ PROC_LINKS(vim_theme_lister, 0), true, "vim_theme_lister", 16, "Opens an interactive list of all registered themes.", 51, "D:\\work\\4ed\\code\\custom\\4coder_vim_lists.cpp", 44, 276 },
{ PROC_LINKS(word_complete, 0), false, "word_complete", 13, "Iteratively tries completing the word to the left of the cursor with other words in open buffers that have the same prefix string.", 130, "D:\\work\\4ed\\code\\custom\\4coder_search.cpp", 41, 433 },
{ PROC_LINKS(word_complete_drop_down, 0), false, "word_complete_drop_down", 23, "Word complete with drop down menu.", 34, "D:\\work\\4ed\\code\\custom\\4coder_search.cpp", 41, 679 },
...
static i32 fcoder_metacmd_ID_explorer = 52;
...
static i32 fcoder_metacmd_ID_luis_adjust_horizontal_view_toggle = 105;
static i32 fcoder_metacmd_ID_luis_build = 106;
static i32 fcoder_metacmd_ID_luis_center_view_top = 107;
static i32 fcoder_metacmd_ID_luis_close_panel = 108;
static i32 fcoder_metacmd_ID_luis_code_index_next = 109;
static i32 fcoder_metacmd_ID_luis_code_index_prev = 110;
static i32 fcoder_metacmd_ID_luis_end = 111;
static i32 fcoder_metacmd_ID_luis_escape = 112;
static i32 fcoder_metacmd_ID_luis_fsearch = 113;
static i32 fcoder_metacmd_ID_luis_home = 114;
static i32 fcoder_metacmd_ID_luis_indent_range = 115;
static i32 fcoder_metacmd_ID_luis_interactive_open_or_new = 116;
static i32 fcoder_metacmd_ID_luis_left_word = 117;
static i32 fcoder_metacmd_ID_luis_list_nests_this_buffer = 118;
static i32 fcoder_metacmd_ID_luis_list_notes_this_buffer = 119;
static i32 fcoder_metacmd_ID_luis_matching_file_cpp = 120;
static i32 fcoder_metacmd_ID_luis_matching_file_cpp_same_buffer = 121;
static i32 fcoder_metacmd_ID_luis_multiline_comment_toggle = 122;
static i32 fcoder_metacmd_ID_luis_return = 123;
static i32 fcoder_metacmd_ID_luis_right_word = 124;
static i32 fcoder_metacmd_ID_luis_rsearch = 125;
static i32 fcoder_metacmd_ID_luis_scope_braces = 126;
static i32 fcoder_metacmd_ID_luis_select_line = 127;
static i32 fcoder_metacmd_ID_luis_select_surrounding_scope = 128;
static i32 fcoder_metacmd_ID_luis_select_surrounding_scope_maximal = 129;
static i32 fcoder_metacmd_ID_luis_set_mark = 130;
static i32 fcoder_metacmd_ID_luis_toggle_modal_mode = 131;
static i32 fcoder_metacmd_ID_luis_view_input_handler = 132;
static i32 fcoder_metacmd_ID_luis_write_newline = 133;
static i32 fcoder_metacmd_ID_luis_write_pointer_arrow = 134;
static i32 fcoder_metacmd_ID_luis_write_tab = 135;
static i32 fcoder_metacmd_ID_luis_write_underscore = 136;
static i32 fcoder_metacmd_ID_make_directory_query = 137;
static i32 fcoder_metacmd_ID_miblo_decrement_basic = 138;
static i32 fcoder_metacmd_ID_miblo_decrement_time_stamp = 139;
static i32 fcoder_metacmd_ID_miblo_decrement_time_stamp_minute = 140;
static i32 fcoder_metacmd_ID_miblo_increment_basic = 141;
static i32 fcoder_metacmd_ID_miblo_increment_time_stamp = 142;
static i32 fcoder_metacmd_ID_miblo_increment_time_stamp_minute = 143;
static i32 fcoder_metacmd_ID_mouse_wheel_change_face_size = 144;
static i32 fcoder_metacmd_ID_mouse_wheel_scroll = 145;
static i32 fcoder_metacmd_ID_move_down = 146;
static i32 fcoder_metacmd_ID_move_down_10 = 147;
static i32 fcoder_metacmd_ID_move_down_textual = 148;
static i32 fcoder_metacmd_ID_move_down_to_blank_line = 149;
static i32 fcoder_metacmd_ID_move_down_to_blank_line_end = 150;
static i32 fcoder_metacmd_ID_move_down_to_blank_line_skip_whitespace = 151;
static i32 fcoder_metacmd_ID_move_left = 152;
static i32 fcoder_metacmd_ID_move_left_alpha_numeric_boundary = 153;
static i32 fcoder_metacmd_ID_move_left_alpha_numeric_or_camel_boundary = 154;
static i32 fcoder_metacmd_ID_move_left_token_boundary = 155;
static i32 fcoder_metacmd_ID_move_left_whitespace_boundary = 156;
static i32 fcoder_metacmd_ID_move_left_whitespace_or_token_boundary = 157;
static i32 fcoder_metacmd_ID_move_line_down = 158;
static i32 fcoder_metacmd_ID_move_line_up = 159;
static i32 fcoder_metacmd_ID_move_right = 160;
static i32 fcoder_metacmd_ID_move_right_alpha_numeric_boundary = 161;
static i32 fcoder_metacmd_ID_move_right_alpha_numeric_or_camel_boundary = 162;
static i32 fcoder_metacmd_ID_move_right_token_boundary = 163;
static i32 fcoder_metacmd_ID_move_right_whitespace_boundary = 164;
static i32 fcoder_metacmd_ID_move_right_whitespace_or_token_boundary = 165;
static i32 fcoder_metacmd_ID_move_up = 166;
static i32 fcoder_metacmd_ID_move_up_10 = 167;
static i32 fcoder_metacmd_ID_move_up_to_blank_line = 168;
static i32 fcoder_metacmd_ID_move_up_to_blank_line_end = 169;
static i32 fcoder_metacmd_ID_move_up_to_blank_line_skip_whitespace = 170;
static i32 fcoder_metacmd_ID_multi_paste = 171;
static i32 fcoder_metacmd_ID_multi_paste_interactive = 172;
static i32 fcoder_metacmd_ID_multi_paste_interactive_quick = 173;
static i32 fcoder_metacmd_ID_music_start = 174;
static i32 fcoder_metacmd_ID_music_stop = 175;
static i32 fcoder_metacmd_ID_open_all_code = 176;
static i32 fcoder_metacmd_ID_open_all_code_recursive = 177;
static i32 fcoder_metacmd_ID_open_file_in_quotes = 178;
static i32 fcoder_metacmd_ID_open_in_other = 179;
static i32 fcoder_metacmd_ID_open_long_braces = 180;
static i32 fcoder_metacmd_ID_open_long_braces_break = 181;
static i32 fcoder_metacmd_ID_open_long_braces_semicolon = 182;
static i32 fcoder_metacmd_ID_open_matching_file_cpp = 183;
static i32 fcoder_metacmd_ID_open_panel_hsplit = 184;
static i32 fcoder_metacmd_ID_open_panel_vsplit = 185;
static i32 fcoder_metacmd_ID_page_down = 186;
static i32 fcoder_metacmd_ID_page_up = 187;
static i32 fcoder_metacmd_ID_paste = 188;
static i32 fcoder_metacmd_ID_paste_and_indent = 189;
static i32 fcoder_metacmd_ID_paste_next = 190;
static i32 fcoder_metacmd_ID_paste_next_and_indent = 191;
static i32 fcoder_metacmd_ID_place_in_scope = 192;
static i32 fcoder_metacmd_ID_play_with_a_counter = 193;
static i32 fcoder_metacmd_ID_profile_clear = 194;
static i32 fcoder_metacmd_ID_profile_disable = 195;
static i32 fcoder_metacmd_ID_profile_enable = 196;
static i32 fcoder_metacmd_ID_profile_inspect = 197;
static i32 fcoder_metacmd_ID_project_command_F1 = 198;
static i32 fcoder_metacmd_ID_project_command_F10 = 199;
static i32 fcoder_metacmd_ID_project_command_F11 = 200;
static i32 fcoder_metacmd_ID_project_command_F12 = 201;
static i32 fcoder_metacmd_ID_project_command_F13 = 202;
static i32 fcoder_metacmd_ID_project_command_F14 = 203;
static i32 fcoder_metacmd_ID_project_command_F15 = 204;
static i32 fcoder_metacmd_ID_project_command_F16 = 205;
static i32 fcoder_metacmd_ID_project_command_F2 = 206;
static i32 fcoder_metacmd_ID_project_command_F3 = 207;
static i32 fcoder_metacmd_ID_project_command_F4 = 208;
static i32 fcoder_metacmd_ID_project_command_F5 = 209;
static i32 fcoder_metacmd_ID_project_command_F6 = 210;
static i32 fcoder_metacmd_ID_project_command_F7 = 211;
static i32 fcoder_metacmd_ID_project_command_F8 = 212;
static i32 fcoder_metacmd_ID_project_command_F9 = 213;
static i32 fcoder_metacmd_ID_project_command_lister = 214;
static i32 fcoder_metacmd_ID_project_fkey_command = 215;
static i32 fcoder_metacmd_ID_project_go_to_root_directory = 216;
static i32 fcoder_metacmd_ID_project_reprint = 217;
static i32 fcoder_metacmd_ID_query_replace = 218;
static i32 fcoder_metacmd_ID_query_replace_identifier = 219;
static i32 fcoder_metacmd_ID_query_replace_selection = 220;
static i32 fcoder_metacmd_ID_quick_swap_buffer = 221;
static i32 fcoder_metacmd_ID_redo = 222;
static i32 fcoder_metacmd_ID_redo_all_buffers = 223;
...
static i32 fcoder_metacmd_ID_string_repeat = 266;
static i32 fcoder_metacmd_ID_suppress_mouse = 267;
static i32 fcoder_metacmd_ID_swap_panels = 268;
static i32 fcoder_metacmd_ID_theme_lister = 269;
static i32 fcoder_metacmd_ID_to_lowercase = 270;
static i32 fcoder_metacmd_ID_to_uppercase = 271;
static i32 fcoder_metacmd_ID_toggle_filebar = 272;
static i32 fcoder_metacmd_ID_toggle_fps_meter = 273;
static i32 fcoder_metacmd_ID_toggle_fullscreen = 274;
static i32 fcoder_metacmd_ID_toggle_highlight_enclosing_scopes = 275;
static i32 fcoder_metacmd_ID_toggle_highlight_line_at_cursor = 276;
static i32 fcoder_metacmd_ID_toggle_line_numbers = 277;
static i32 fcoder_metacmd_ID_toggle_line_wrap = 278;
static i32 fcoder_metacmd_ID_toggle_mouse = 279;
static i32 fcoder_metacmd_ID_toggle_paren_matching_helper = 280;
static i32 fcoder_metacmd_ID_toggle_show_whitespace = 281;
static i32 fcoder_metacmd_ID_toggle_virtual_whitespace = 282;
static i32 fcoder_metacmd_ID_tutorial_maximize = 283;
static i32 fcoder_metacmd_ID_tutorial_minimize = 284;
static i32 fcoder_metacmd_ID_uncomment_line = 285;
static i32 fcoder_metacmd_ID_undo = 286;
static i32 fcoder_metacmd_ID_undo_all_buffers = 287;
static i32 fcoder_metacmd_ID_view_buffer_other_panel = 288;
static i32 fcoder_metacmd_ID_view_jump_list_with_lister = 289;
static i32 fcoder_metacmd_ID_vim_command_mode = 290;
static i32 fcoder_metacmd_ID_vim_interactive_open_or_new = 291;
static i32 fcoder_metacmd_ID_vim_list_all_functions_current_buffer_lister = 292;
static i32 fcoder_metacmd_ID_vim_proj_cmd_lister = 293;
static i32 fcoder_metacmd_ID_vim_switch_lister = 294;
static i32 fcoder_metacmd_ID_vim_theme_lister = 295;
static i32 fcoder_metacmd_ID_word_complete = 296;
static i32 fcoder_metacmd_ID_word_complete_drop_down = 297;
static i32 fcoder_metacmd_ID_write_block = 298;
static i32 fcoder_metacmd_ID_write_hack = 299;
static i32 fcoder_metacmd_ID_write_note = 300;
static i32 fcoder_metacmd_ID_write_space = 301;
static i32 fcoder_metacmd_ID_write_text_and_auto_indent = 302;
static i32 fcoder_metacmd_ID_write_text_input = 303;
static i32 fcoder_metacmd_ID_write_todo = 304;
static i32 fcoder_metacmd_ID_write_underscore = 305;
static i32 fcoder_metacmd_ID_write_zero_struct = 306;
#endif
