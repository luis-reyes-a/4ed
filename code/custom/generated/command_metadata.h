...
#define command_one_past_last_id 336
...
static Command_Metadata fcoder_metacmd_table[336] = {
...
{ PROC_LINKS(ctrl_tab_switch_buffer, 0), true, "ctrl_tab_switch_buffer", 22, "Alt-tab behaviour way of switching buffer", 41, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 2169 },
...
{ PROC_LINKS(emacs_copy, 0), false, "emacs_copy", 10, "emacs cut or 'kill'", 19, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 211 },
{ PROC_LINKS(emacs_cut, 0), false, "emacs_cut", 9, "emacs cut or 'kill'", 19, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 205 },
{ PROC_LINKS(emacs_kill_line, 0), false, "emacs_kill_line", 15, "Emacs-style kill line", 21, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 510 },
{ PROC_LINKS(emacs_swap_cursor_mark, 0), false, "emacs_swap_cursor_mark", 22, "swap cursor and mark (works with notepad mode)", 46, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 552 },
...
{ PROC_LINKS(luis_add_space, 0), false, "luis_add_space", 14, "add space to line start", 23, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 356 },
{ PROC_LINKS(luis_add_tab, 0), false, "luis_add_tab", 12, "add tab to line start", 21, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 324 },
{ PROC_LINKS(luis_adjust_horizontal_view_toggle, 0), false, "luis_adjust_horizontal_view_toggle", 34, "Moves view horizontally to cursor x pos or back to leftmost of screen", 69, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 718 },
{ PROC_LINKS(luis_backspace_char, 0), false, "luis_backspace_char", 19, "delete char", 11, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 195 },
{ PROC_LINKS(luis_build, 0), false, "luis_build", 10, "build", 5, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1181 },
{ PROC_LINKS(luis_center_view_top, 0), false, "luis_center_view_top", 20, "Centers the view vertically on the line on which the cursor sits.", 65, "d:\\work\\4ed\\code\\custom\\luis_custom_layer.h", 43, 332 },
{ PROC_LINKS(luis_close_all_other_panels, 0), false, "luis_close_all_other_panels", 27, "Close all panels except active one", 34, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 856 },
{ PROC_LINKS(luis_close_current_panel, 0), false, "luis_close_current_panel", 24, "Close current panel", 19, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 882 },
{ PROC_LINKS(luis_code_index_next, 0), false, "luis_code_index_next", 20, "next code index", 15, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3186 },
{ PROC_LINKS(luis_code_index_prev, 0), false, "luis_code_index_prev", 20, "prev code index", 15, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3205 },
{ PROC_LINKS(luis_delete_char, 0), false, "luis_delete_char", 16, "delete char", 11, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 185 },
...
{ PROC_LINKS(luis_end, 0), false, "luis_end", 8, "go end of visual line", 21, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 815 },
{ PROC_LINKS(luis_escape, 0), false, "luis_escape", 11, "escape key", 10, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 93 },
{ PROC_LINKS(luis_fsearch, 0), false, "luis_fsearch", 12, "search forwards", 15, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3549 },
{ PROC_LINKS(luis_goto_next_jump, 0), false, "luis_goto_next_jump", 19, "If a buffer containing jump locations has been locked in, goes to the next jump in the buffer, skipping sub jump locations.", 123, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1151 },
{ PROC_LINKS(luis_goto_prev_jump, 0), false, "luis_goto_prev_jump", 19, "If a buffer containing jump locations has been locked in, goes to the previous jump in the buffer, skipping sub jump locations.", 127, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1167 },
{ PROC_LINKS(luis_home, 0), false, "luis_home", 9, "go start of visual line", 23, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 126 },
{ PROC_LINKS(luis_horizontal_mouse_wheel_scroll, 0), false, "luis_horizontal_mouse_wheel_scroll", 34, "Reads the scroll wheel value from the mouse state and scrolls accordingly.", 74, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 742 },
{ PROC_LINKS(luis_indent_range, 0), false, "luis_indent_range", 17, "indent_range", 12, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 309 },
{ PROC_LINKS(luis_interactive_open_or_new, 0), false, "luis_interactive_open_or_new", 28, "open in new in same tab", 23, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 112 },
{ PROC_LINKS(luis_left_word, 0), false, "luis_left_word", 14, "move left", 9, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 134 },
{ PROC_LINKS(luis_list_functions_all_buffers, 0), false, "luis_list_functions_all_buffers", 31, "Show code indexes for all buffer", 32, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1715 },
{ PROC_LINKS(luis_list_nests_this_buffer, 0), false, "luis_list_nests_this_buffer", 27, "Show code nests for this buffer", 31, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1296 },
{ PROC_LINKS(luis_list_notes_all_buffers, 0), false, "luis_list_notes_all_buffers", 27, "Show code indexes for all buffer", 32, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1612 },
{ PROC_LINKS(luis_list_notes_no_duplicates, 0), false, "luis_list_notes_no_duplicates", 29, "Show code indexes for all buffer with no duplicates", 51, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1861 },
{ PROC_LINKS(luis_list_notes_this_buffer, 0), false, "luis_list_notes_this_buffer", 27, "Show code indexes for buffer", 28, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1364 },
{ PROC_LINKS(luis_matching_file_cpp, 0), false, "luis_matching_file_cpp", 22, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1042 },
{ PROC_LINKS(luis_matching_file_cpp_same_buffer, 0), false, "luis_matching_file_cpp_same_buffer", 34, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1032 },
{ PROC_LINKS(luis_multiline_comment_toggle, 0), false, "luis_multiline_comment_toggle", 29, "Deletes all whitespace at cursor, going backwards", 49, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 757 },
{ PROC_LINKS(luis_open_build_panel, 0), false, "luis_open_build_panel", 21, "open build panel", 16, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1223 },
{ PROC_LINKS(luis_open_up_braces, 0), false, "luis_open_up_braces", 19, "open braces up", 14, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 283 },
{ PROC_LINKS(luis_print_scope_variables, 0), false, "luis_print_scope_variables", 26, "print scope variables", 21, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 2018 },
{ PROC_LINKS(luis_remove_space, 0), false, "luis_remove_space", 17, "remove space from line start", 28, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 429 },
{ PROC_LINKS(luis_remove_tab, 0), false, "luis_remove_tab", 15, "remove tab from line start", 26, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 380 },
{ PROC_LINKS(luis_reselect_selection, 0), false, "luis_reselect_selection", 23, "create selection where cursor is and mark was", 45, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 583 },
{ PROC_LINKS(luis_return, 0), false, "luis_return", 11, "If the buffer in the active view is writable, inserts a character, otherwise performs goto_jump_at_cursor.", 106, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1056 },
{ PROC_LINKS(luis_right_word, 0), false, "luis_right_word", 15, "move right", 10, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 141 },
{ PROC_LINKS(luis_rsearch, 0), false, "luis_rsearch", 12, "search backwards", 16, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3556 },
{ PROC_LINKS(luis_scope_braces, 0), false, "luis_scope_braces", 17, "writes {}", 9, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 234 },
{ PROC_LINKS(luis_select_line, 0), false, "luis_select_line", 16, "go end of visual line", 21, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 483 },
{ PROC_LINKS(luis_select_scope_contents, 0), false, "luis_select_scope_contents", 26, "if you have a scope selected, select just the contents of it", 60, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 638 },
{ PROC_LINKS(luis_select_surrounding_scope, 0), false, "luis_select_surrounding_scope", 29, "select surrounding scope", 24, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 601 },
{ PROC_LINKS(luis_select_surrounding_scope_maximal, 0), false, "luis_select_surrounding_scope_maximal", 37, "select surrounding scope", 24, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 680 },
{ PROC_LINKS(luis_select_word_under_cursor, 0), false, "luis_select_word_under_cursor", 29, "Select text at cursor", 21, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 171 },
{ PROC_LINKS(luis_set_mark, 0), false, "luis_set_mark", 13, "set mark", 8, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 165 },
{ PROC_LINKS(luis_show_search_panel, 0), false, "luis_show_search_panel", 22, "Enter Command Mode", 18, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3299 },
...
{ PROC_LINKS(luis_toggle_modal_mode, 0), false, "luis_toggle_modal_mode", 22, "Toggles modal mode", 18, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 99 },
{ PROC_LINKS(luis_try_exit, 0), false, "luis_try_exit", 13, "Default command for responding to a try-exit event", 50, "d:\\work\\4ed\\code\\custom\\luis_hooks.cpp", 38, 1037 },
{ PROC_LINKS(luis_view_input_handler, 0), false, "luis_view_input_handler", 23, "Input consumption loop for default view behavior", 48, "d:\\work\\4ed\\code\\custom\\luis_hooks.cpp", 38, 47 },
{ PROC_LINKS(luis_view_peek_as_split_window, 0), false, "luis_view_peek_as_split_window", 30, "view peek buffer in split window", 32, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 904 },
{ PROC_LINKS(luis_view_peek_in_parent_window, 0), false, "luis_view_peek_in_parent_window", 31, "view peek buffer in split window", 32, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 957 },
{ PROC_LINKS(luis_vim_string_matches, 0), true, "luis_vim_string_matches", 23, "Enter Command Mode", 18, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3266 },
{ PROC_LINKS(luis_write_newline, 0), false, "luis_write_newline", 18, "", 0, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 707 },
{ PROC_LINKS(luis_write_pointer_arrow, 0), false, "luis_write_pointer_arrow", 24, "", 0, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 703 },
{ PROC_LINKS(luis_write_tab, 0), false, "luis_write_tab", 14, "", 0, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 711 },
{ PROC_LINKS(luis_write_underscore, 0), false, "luis_write_underscore", 21, "", 0, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 699 },
...
{ PROC_LINKS(open_file_in_10x, 0), false, "open_file_in_10x", 16, "Open current file in 10x", 24, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 70 },
...
{ PROC_LINKS(open_file_in_visual_studio, 0), false, "open_file_in_visual_studio", 26, "Open current file in visual studio", 34, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 46 },
...
{ PROC_LINKS(reload_project, 0), false, "reload_project", 14, "Reload project.4coder", 21, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1544 },
...
{ PROC_LINKS(show_file_in_explorer, 0), false, "show_file_in_explorer", 21, "Opens file explorer in hot directory", 36, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 28 },
...
static i32 fcoder_metacmd_ID_luis_add_space = 109;
static i32 fcoder_metacmd_ID_luis_add_tab = 110;
static i32 fcoder_metacmd_ID_luis_adjust_horizontal_view_toggle = 111;
static i32 fcoder_metacmd_ID_luis_backspace_char = 112;
static i32 fcoder_metacmd_ID_luis_build = 113;
static i32 fcoder_metacmd_ID_luis_center_view_top = 114;
static i32 fcoder_metacmd_ID_luis_close_all_other_panels = 115;
static i32 fcoder_metacmd_ID_luis_close_current_panel = 116;
static i32 fcoder_metacmd_ID_luis_code_index_next = 117;
static i32 fcoder_metacmd_ID_luis_code_index_prev = 118;
static i32 fcoder_metacmd_ID_luis_delete_char = 119;
static i32 fcoder_metacmd_ID_luis_eat_whitespace_backwards = 120;
static i32 fcoder_metacmd_ID_luis_end = 121;
static i32 fcoder_metacmd_ID_luis_escape = 122;
static i32 fcoder_metacmd_ID_luis_fsearch = 123;
static i32 fcoder_metacmd_ID_luis_goto_next_jump = 124;
static i32 fcoder_metacmd_ID_luis_goto_prev_jump = 125;
static i32 fcoder_metacmd_ID_luis_home = 126;
static i32 fcoder_metacmd_ID_luis_horizontal_mouse_wheel_scroll = 127;
static i32 fcoder_metacmd_ID_luis_indent_range = 128;
static i32 fcoder_metacmd_ID_luis_interactive_open_or_new = 129;
static i32 fcoder_metacmd_ID_luis_left_word = 130;
static i32 fcoder_metacmd_ID_luis_list_functions_all_buffers = 131;
static i32 fcoder_metacmd_ID_luis_list_nests_this_buffer = 132;
static i32 fcoder_metacmd_ID_luis_list_notes_all_buffers = 133;
static i32 fcoder_metacmd_ID_luis_list_notes_no_duplicates = 134;
static i32 fcoder_metacmd_ID_luis_list_notes_this_buffer = 135;
static i32 fcoder_metacmd_ID_luis_matching_file_cpp = 136;
static i32 fcoder_metacmd_ID_luis_matching_file_cpp_same_buffer = 137;
static i32 fcoder_metacmd_ID_luis_multiline_comment_toggle = 138;
static i32 fcoder_metacmd_ID_luis_open_build_panel = 139;
static i32 fcoder_metacmd_ID_luis_open_up_braces = 140;
static i32 fcoder_metacmd_ID_luis_print_scope_variables = 141;
static i32 fcoder_metacmd_ID_luis_remove_space = 142;
static i32 fcoder_metacmd_ID_luis_remove_tab = 143;
static i32 fcoder_metacmd_ID_luis_reselect_selection = 144;
static i32 fcoder_metacmd_ID_luis_return = 145;
static i32 fcoder_metacmd_ID_luis_right_word = 146;
static i32 fcoder_metacmd_ID_luis_rsearch = 147;
static i32 fcoder_metacmd_ID_luis_scope_braces = 148;
static i32 fcoder_metacmd_ID_luis_select_line = 149;
static i32 fcoder_metacmd_ID_luis_select_scope_contents = 150;
static i32 fcoder_metacmd_ID_luis_select_surrounding_scope = 151;
static i32 fcoder_metacmd_ID_luis_select_surrounding_scope_maximal = 152;
static i32 fcoder_metacmd_ID_luis_select_word_under_cursor = 153;
static i32 fcoder_metacmd_ID_luis_set_mark = 154;
static i32 fcoder_metacmd_ID_luis_show_search_panel = 155;
static i32 fcoder_metacmd_ID_luis_startup = 156;
static i32 fcoder_metacmd_ID_luis_toggle_modal_mode = 157;
static i32 fcoder_metacmd_ID_luis_try_exit = 158;
static i32 fcoder_metacmd_ID_luis_view_input_handler = 159;
static i32 fcoder_metacmd_ID_luis_view_peek_as_split_window = 160;
static i32 fcoder_metacmd_ID_luis_view_peek_in_parent_window = 161;
static i32 fcoder_metacmd_ID_luis_vim_string_matches = 162;
static i32 fcoder_metacmd_ID_luis_write_newline = 163;
static i32 fcoder_metacmd_ID_luis_write_pointer_arrow = 164;
static i32 fcoder_metacmd_ID_luis_write_tab = 165;
static i32 fcoder_metacmd_ID_luis_write_underscore = 166;
static i32 fcoder_metacmd_ID_make_directory_query = 167;
static i32 fcoder_metacmd_ID_miblo_decrement_basic = 168;
static i32 fcoder_metacmd_ID_miblo_decrement_time_stamp = 169;
static i32 fcoder_metacmd_ID_miblo_decrement_time_stamp_minute = 170;
static i32 fcoder_metacmd_ID_miblo_increment_basic = 171;
static i32 fcoder_metacmd_ID_miblo_increment_time_stamp = 172;
static i32 fcoder_metacmd_ID_miblo_increment_time_stamp_minute = 173;
static i32 fcoder_metacmd_ID_mouse_wheel_change_face_size = 174;
static i32 fcoder_metacmd_ID_mouse_wheel_scroll = 175;
static i32 fcoder_metacmd_ID_move_down = 176;
static i32 fcoder_metacmd_ID_move_down_10 = 177;
static i32 fcoder_metacmd_ID_move_down_textual = 178;
static i32 fcoder_metacmd_ID_move_down_to_blank_line = 179;
static i32 fcoder_metacmd_ID_move_down_to_blank_line_end = 180;
static i32 fcoder_metacmd_ID_move_down_to_blank_line_skip_whitespace = 181;
static i32 fcoder_metacmd_ID_move_left = 182;
static i32 fcoder_metacmd_ID_move_left_alpha_numeric_boundary = 183;
static i32 fcoder_metacmd_ID_move_left_alpha_numeric_or_camel_boundary = 184;
static i32 fcoder_metacmd_ID_move_left_token_boundary = 185;
static i32 fcoder_metacmd_ID_move_left_whitespace_boundary = 186;
static i32 fcoder_metacmd_ID_move_left_whitespace_or_token_boundary = 187;
static i32 fcoder_metacmd_ID_move_line_down = 188;
static i32 fcoder_metacmd_ID_move_line_up = 189;
static i32 fcoder_metacmd_ID_move_right = 190;
static i32 fcoder_metacmd_ID_move_right_alpha_numeric_boundary = 191;
static i32 fcoder_metacmd_ID_move_right_alpha_numeric_or_camel_boundary = 192;
static i32 fcoder_metacmd_ID_move_right_token_boundary = 193;
static i32 fcoder_metacmd_ID_move_right_whitespace_boundary = 194;
static i32 fcoder_metacmd_ID_move_right_whitespace_or_token_boundary = 195;
static i32 fcoder_metacmd_ID_move_up = 196;
static i32 fcoder_metacmd_ID_move_up_10 = 197;
static i32 fcoder_metacmd_ID_move_up_to_blank_line = 198;
static i32 fcoder_metacmd_ID_move_up_to_blank_line_end = 199;
static i32 fcoder_metacmd_ID_move_up_to_blank_line_skip_whitespace = 200;
static i32 fcoder_metacmd_ID_multi_paste = 201;
static i32 fcoder_metacmd_ID_multi_paste_interactive = 202;
static i32 fcoder_metacmd_ID_multi_paste_interactive_quick = 203;
static i32 fcoder_metacmd_ID_music_start = 204;
static i32 fcoder_metacmd_ID_music_stop = 205;
static i32 fcoder_metacmd_ID_open_all_code = 206;
static i32 fcoder_metacmd_ID_open_all_code_recursive = 207;
static i32 fcoder_metacmd_ID_open_file_in_10x = 208;
static i32 fcoder_metacmd_ID_open_file_in_quotes = 209;
static i32 fcoder_metacmd_ID_open_file_in_visual_studio = 210;
static i32 fcoder_metacmd_ID_open_in_other = 211;
static i32 fcoder_metacmd_ID_open_long_braces = 212;
static i32 fcoder_metacmd_ID_open_long_braces_break = 213;
static i32 fcoder_metacmd_ID_open_long_braces_semicolon = 214;
static i32 fcoder_metacmd_ID_open_matching_file_cpp = 215;
static i32 fcoder_metacmd_ID_open_panel_hsplit = 216;
static i32 fcoder_metacmd_ID_open_panel_vsplit = 217;
static i32 fcoder_metacmd_ID_page_down = 218;
static i32 fcoder_metacmd_ID_page_up = 219;
static i32 fcoder_metacmd_ID_paste = 220;
static i32 fcoder_metacmd_ID_paste_and_indent = 221;
static i32 fcoder_metacmd_ID_paste_next = 222;
static i32 fcoder_metacmd_ID_paste_next_and_indent = 223;
static i32 fcoder_metacmd_ID_place_in_scope = 224;
static i32 fcoder_metacmd_ID_play_with_a_counter = 225;
static i32 fcoder_metacmd_ID_profile_clear = 226;
static i32 fcoder_metacmd_ID_profile_disable = 227;
static i32 fcoder_metacmd_ID_profile_enable = 228;
static i32 fcoder_metacmd_ID_profile_inspect = 229;
static i32 fcoder_metacmd_ID_project_command_F1 = 230;
static i32 fcoder_metacmd_ID_project_command_F10 = 231;
static i32 fcoder_metacmd_ID_project_command_F11 = 232;
static i32 fcoder_metacmd_ID_project_command_F12 = 233;
static i32 fcoder_metacmd_ID_project_command_F13 = 234;
static i32 fcoder_metacmd_ID_project_command_F14 = 235;
static i32 fcoder_metacmd_ID_project_command_F15 = 236;
static i32 fcoder_metacmd_ID_project_command_F16 = 237;
static i32 fcoder_metacmd_ID_project_command_F2 = 238;
static i32 fcoder_metacmd_ID_project_command_F3 = 239;
static i32 fcoder_metacmd_ID_project_command_F4 = 240;
static i32 fcoder_metacmd_ID_project_command_F5 = 241;
static i32 fcoder_metacmd_ID_project_command_F6 = 242;
static i32 fcoder_metacmd_ID_project_command_F7 = 243;
static i32 fcoder_metacmd_ID_project_command_F8 = 244;
static i32 fcoder_metacmd_ID_project_command_F9 = 245;
static i32 fcoder_metacmd_ID_project_command_lister = 246;
static i32 fcoder_metacmd_ID_project_fkey_command = 247;
static i32 fcoder_metacmd_ID_project_go_to_root_directory = 248;
static i32 fcoder_metacmd_ID_project_reprint = 249;
static i32 fcoder_metacmd_ID_query_replace = 250;
static i32 fcoder_metacmd_ID_query_replace_identifier = 251;
static i32 fcoder_metacmd_ID_query_replace_selection = 252;
static i32 fcoder_metacmd_ID_quick_swap_buffer = 253;
static i32 fcoder_metacmd_ID_redo = 254;
static i32 fcoder_metacmd_ID_redo_all_buffers = 255;
static i32 fcoder_metacmd_ID_reload_project = 256;
static i32 fcoder_metacmd_ID_rename_file_query = 257;
static i32 fcoder_metacmd_ID_reopen = 258;
static i32 fcoder_metacmd_ID_replace_in_all_buffers = 259;
static i32 fcoder_metacmd_ID_replace_in_buffer = 260;
static i32 fcoder_metacmd_ID_replace_in_range = 261;
static i32 fcoder_metacmd_ID_reverse_search = 262;
static i32 fcoder_metacmd_ID_reverse_search_identifier = 263;
static i32 fcoder_metacmd_ID_save = 264;
static i32 fcoder_metacmd_ID_save_all_dirty_buffers = 265;
static i32 fcoder_metacmd_ID_save_to_query = 266;
static i32 fcoder_metacmd_ID_search = 267;
static i32 fcoder_metacmd_ID_search_identifier = 268;
static i32 fcoder_metacmd_ID_seek_beginning_of_line = 269;
static i32 fcoder_metacmd_ID_seek_beginning_of_textual_line = 270;
static i32 fcoder_metacmd_ID_seek_end_of_line = 271;
static i32 fcoder_metacmd_ID_seek_end_of_textual_line = 272;
static i32 fcoder_metacmd_ID_select_all = 273;
static i32 fcoder_metacmd_ID_select_next_scope_absolute = 274;
static i32 fcoder_metacmd_ID_select_next_scope_after_current = 275;
static i32 fcoder_metacmd_ID_select_prev_scope_absolute = 276;
static i32 fcoder_metacmd_ID_select_prev_top_most_scope = 277;
static i32 fcoder_metacmd_ID_select_surrounding_scope = 278;
static i32 fcoder_metacmd_ID_select_surrounding_scope_maximal = 279;
static i32 fcoder_metacmd_ID_set_eol_mode_from_contents = 280;
static i32 fcoder_metacmd_ID_set_eol_mode_to_binary = 281;
static i32 fcoder_metacmd_ID_set_eol_mode_to_crlf = 282;
static i32 fcoder_metacmd_ID_set_eol_mode_to_lf = 283;
static i32 fcoder_metacmd_ID_set_face_size = 284;
static i32 fcoder_metacmd_ID_set_face_size_this_buffer = 285;
static i32 fcoder_metacmd_ID_set_mark = 286;
static i32 fcoder_metacmd_ID_set_mode_to_notepad_like = 287;
static i32 fcoder_metacmd_ID_set_mode_to_original = 288;
static i32 fcoder_metacmd_ID_setup_build_bat = 289;
static i32 fcoder_metacmd_ID_setup_build_bat_and_sh = 290;
static i32 fcoder_metacmd_ID_setup_build_sh = 291;
static i32 fcoder_metacmd_ID_setup_new_project = 292;
static i32 fcoder_metacmd_ID_show_file_in_explorer = 293;
static i32 fcoder_metacmd_ID_show_filebar = 294;
static i32 fcoder_metacmd_ID_show_scrollbar = 295;
static i32 fcoder_metacmd_ID_show_the_log_graph = 296;
static i32 fcoder_metacmd_ID_snipe_backward_whitespace_or_token_boundary = 297;
static i32 fcoder_metacmd_ID_snipe_forward_whitespace_or_token_boundary = 298;
static i32 fcoder_metacmd_ID_snippet_lister = 299;
static i32 fcoder_metacmd_ID_string_repeat = 300;
static i32 fcoder_metacmd_ID_suppress_mouse = 301;
static i32 fcoder_metacmd_ID_swap_panels = 302;
static i32 fcoder_metacmd_ID_theme_lister = 303;
static i32 fcoder_metacmd_ID_to_lowercase = 304;
static i32 fcoder_metacmd_ID_to_uppercase = 305;
static i32 fcoder_metacmd_ID_toggle_filebar = 306;
static i32 fcoder_metacmd_ID_toggle_fps_meter = 307;
static i32 fcoder_metacmd_ID_toggle_fullscreen = 308;
static i32 fcoder_metacmd_ID_toggle_highlight_enclosing_scopes = 309;
static i32 fcoder_metacmd_ID_toggle_highlight_line_at_cursor = 310;
static i32 fcoder_metacmd_ID_toggle_line_numbers = 311;
static i32 fcoder_metacmd_ID_toggle_line_wrap = 312;
static i32 fcoder_metacmd_ID_toggle_mouse = 313;
static i32 fcoder_metacmd_ID_toggle_paren_matching_helper = 314;
static i32 fcoder_metacmd_ID_toggle_show_whitespace = 315;
static i32 fcoder_metacmd_ID_toggle_text_drop_shadow = 316;
static i32 fcoder_metacmd_ID_toggle_virtual_whitespace = 317;
static i32 fcoder_metacmd_ID_tutorial_maximize = 318;
static i32 fcoder_metacmd_ID_tutorial_minimize = 319;
static i32 fcoder_metacmd_ID_uncomment_line = 320;
static i32 fcoder_metacmd_ID_undo = 321;
static i32 fcoder_metacmd_ID_undo_all_buffers = 322;
static i32 fcoder_metacmd_ID_view_buffer_other_panel = 323;
static i32 fcoder_metacmd_ID_view_jump_list_with_lister = 324;
static i32 fcoder_metacmd_ID_word_complete = 325;
static i32 fcoder_metacmd_ID_word_complete_drop_down = 326;
static i32 fcoder_metacmd_ID_write_block = 327;
static i32 fcoder_metacmd_ID_write_hack = 328;
static i32 fcoder_metacmd_ID_write_note = 329;
static i32 fcoder_metacmd_ID_write_space = 330;
static i32 fcoder_metacmd_ID_write_text_and_auto_indent = 331;
static i32 fcoder_metacmd_ID_write_text_input = 332;
static i32 fcoder_metacmd_ID_write_todo = 333;
static i32 fcoder_metacmd_ID_write_underscore = 334;
static i32 fcoder_metacmd_ID_write_zero_struct = 335;
#endif
