...
{ PROC_LINKS(allow_mouse, 0), false, "allow_mouse", 11, "Shows the mouse and causes all mouse input to be processed normally.", 68, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 490 },
...
{ PROC_LINKS(change_active_panel, 0), false, "change_active_panel", 19, "Change the currently active panel, moving to the panel with the next highest view_id.", 85, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 365 },
{ PROC_LINKS(change_active_panel_backwards, 0), false, "change_active_panel_backwards", 29, "Change the currently active panel, moving to the panel with the next lowest view_id.", 84, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 371 },
...
{ PROC_LINKS(clear_all_themes, 0), false, "clear_all_themes", 16, "Clear the theme list", 20, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 574 },
...
{ PROC_LINKS(ctrl_tab_switch_buffer, 0), true, "ctrl_tab_switch_buffer", 22, "Alt-tab behaviour way of switching buffer", 41, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 2256 },
...
{ PROC_LINKS(emacs_copy, 0), false, "emacs_copy", 10, "emacs cut or 'kill'", 19, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 249 },
{ PROC_LINKS(emacs_cut, 0), false, "emacs_cut", 9, "emacs cut or 'kill'", 19, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 243 },
{ PROC_LINKS(emacs_kill_line, 0), false, "emacs_kill_line", 15, "Emacs-style kill line", 21, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 548 },
{ PROC_LINKS(emacs_swap_cursor_mark, 0), false, "emacs_swap_cursor_mark", 22, "swap cursor and mark (works with notepad mode)", 46, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 590 },
...
{ PROC_LINKS(load_themes_default_folder, 0), false, "load_themes_default_folder", 26, "Loads all the theme files in the default theme folder.", 54, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 544 },
{ PROC_LINKS(load_themes_hot_directory, 0), false, "load_themes_hot_directory", 25, "Loads all the theme files in the current hot directory.", 55, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 563 },
{ PROC_LINKS(luis_add_space, 0), false, "luis_add_space", 14, "add space to line start", 23, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 394 },
{ PROC_LINKS(luis_add_tab, 0), false, "luis_add_tab", 12, "add tab to line start", 21, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 362 },
{ PROC_LINKS(luis_adjust_horizontal_view_toggle, 0), false, "luis_adjust_horizontal_view_toggle", 34, "Moves view horizontally to cursor x pos or back to leftmost of screen", 69, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 756 },
{ PROC_LINKS(luis_backspace_char, 0), false, "luis_backspace_char", 19, "delete char", 11, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 233 },
{ PROC_LINKS(luis_build, 0), false, "luis_build", 10, "build", 5, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1265 },
...
{ PROC_LINKS(luis_close_all_other_panels, 0), false, "luis_close_all_other_panels", 27, "Close all panels except active one", 34, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 940 },
{ PROC_LINKS(luis_close_current_panel, 0), false, "luis_close_current_panel", 24, "Close current panel", 19, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 966 },
{ PROC_LINKS(luis_code_index_next, 0), false, "luis_code_index_next", 20, "next code index", 15, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3004 },
{ PROC_LINKS(luis_code_index_prev, 0), false, "luis_code_index_prev", 20, "prev code index", 15, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3023 },
{ PROC_LINKS(luis_delete_char, 0), false, "luis_delete_char", 16, "delete char", 11, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 223 },
...
{ PROC_LINKS(luis_end, 0), false, "luis_end", 8, "go end of visual line", 21, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 853 },
{ PROC_LINKS(luis_escape, 0), false, "luis_escape", 11, "escape key", 10, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 125 },
{ PROC_LINKS(luis_fsearch, 0), false, "luis_fsearch", 12, "search forwards", 15, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3367 },
{ PROC_LINKS(luis_goto_next_jump, 0), false, "luis_goto_next_jump", 19, "If a buffer containing jump locations has been locked in, goes to the next jump in the buffer, skipping sub jump locations.", 123, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1235 },
{ PROC_LINKS(luis_goto_prev_jump, 0), false, "luis_goto_prev_jump", 19, "If a buffer containing jump locations has been locked in, goes to the previous jump in the buffer, skipping sub jump locations.", 127, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1251 },
{ PROC_LINKS(luis_home, 0), false, "luis_home", 9, "go start of visual line", 23, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 164 },
{ PROC_LINKS(luis_horizontal_mouse_wheel_scroll, 0), false, "luis_horizontal_mouse_wheel_scroll", 34, "Reads the scroll wheel value from the mouse state and scrolls accordingly.", 74, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 780 },
{ PROC_LINKS(luis_indent_range, 0), false, "luis_indent_range", 17, "indent_range", 12, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 347 },
{ PROC_LINKS(luis_interactive_open_or_new, 0), false, "luis_interactive_open_or_new", 28, "open in new in same tab", 23, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 150 },
{ PROC_LINKS(luis_left_word, 0), false, "luis_left_word", 14, "move left", 9, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 172 },
{ PROC_LINKS(luis_list_functions_all_buffers, 0), false, "luis_list_functions_all_buffers", 31, "Show code indexes for all buffer", 32, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1801 },
{ PROC_LINKS(luis_list_nests_this_buffer, 0), false, "luis_list_nests_this_buffer", 27, "Show code nests for this buffer", 31, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1380 },
{ PROC_LINKS(luis_list_notes_all_buffers, 0), false, "luis_list_notes_all_buffers", 27, "Show code indexes for all buffer", 32, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1697 },
{ PROC_LINKS(luis_list_notes_no_duplicates, 0), false, "luis_list_notes_no_duplicates", 29, "Show code indexes for all buffer with no duplicates", 51, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1947 },
{ PROC_LINKS(luis_list_notes_this_buffer, 0), false, "luis_list_notes_this_buffer", 27, "Show code indexes for buffer", 28, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1448 },
{ PROC_LINKS(luis_matching_file_cpp, 0), false, "luis_matching_file_cpp", 22, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1126 },
{ PROC_LINKS(luis_matching_file_cpp_same_buffer, 0), false, "luis_matching_file_cpp_same_buffer", 34, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1116 },
{ PROC_LINKS(luis_multiline_comment_toggle, 0), false, "luis_multiline_comment_toggle", 29, "Deletes all whitespace at cursor, going backwards", 49, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 795 },
{ PROC_LINKS(luis_open_build_panel, 0), false, "luis_open_build_panel", 21, "open build panel", 16, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1307 },
{ PROC_LINKS(luis_open_up_braces, 0), false, "luis_open_up_braces", 19, "open braces up", 14, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 321 },
{ PROC_LINKS(luis_peek_scopes, 0), false, "luis_peek_scopes", 16, "peek at top of scopes to get a sense of where you are", 53, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3382 },
{ PROC_LINKS(luis_print_scope_variables, 0), false, "luis_print_scope_variables", 26, "print scope variables", 21, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 2105 },
{ PROC_LINKS(luis_remove_space, 0), false, "luis_remove_space", 17, "remove space from line start", 28, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 467 },
{ PROC_LINKS(luis_remove_tab, 0), false, "luis_remove_tab", 15, "remove tab from line start", 26, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 418 },
{ PROC_LINKS(luis_reselect_selection, 0), false, "luis_reselect_selection", 23, "create selection where cursor is and mark was", 45, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 621 },
{ PROC_LINKS(luis_return, 0), false, "luis_return", 11, "If the buffer in the active view is writable, inserts a character, otherwise performs goto_jump_at_cursor.", 106, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1140 },
{ PROC_LINKS(luis_right_word, 0), false, "luis_right_word", 15, "move right", 10, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 179 },
{ PROC_LINKS(luis_rsearch, 0), false, "luis_rsearch", 12, "search backwards", 16, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3374 },
{ PROC_LINKS(luis_scope_braces, 0), false, "luis_scope_braces", 17, "writes {}", 9, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 272 },
{ PROC_LINKS(luis_select_line, 0), false, "luis_select_line", 16, "go end of visual line", 21, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 521 },
{ PROC_LINKS(luis_select_scope_contents, 0), false, "luis_select_scope_contents", 26, "if you have a scope selected, select just the contents of it", 60, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 676 },
{ PROC_LINKS(luis_select_surrounding_scope, 0), false, "luis_select_surrounding_scope", 29, "select surrounding scope", 24, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 639 },
{ PROC_LINKS(luis_select_surrounding_scope_maximal, 0), false, "luis_select_surrounding_scope_maximal", 37, "select surrounding scope", 24, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 718 },
{ PROC_LINKS(luis_select_word_under_cursor, 0), false, "luis_select_word_under_cursor", 29, "Select text at cursor", 21, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 209 },
{ PROC_LINKS(luis_set_mark, 0), false, "luis_set_mark", 13, "set mark", 8, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 203 },
{ PROC_LINKS(luis_show_search_panel, 0), false, "luis_show_search_panel", 22, "Enter Command Mode", 18, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3117 },
...
{ PROC_LINKS(luis_toggle_modal_mode, 0), false, "luis_toggle_modal_mode", 22, "Toggles modal mode", 18, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 131 },
...
{ PROC_LINKS(luis_view_peek_as_split_window, 0), false, "luis_view_peek_as_split_window", 30, "view peek buffer in split window", 32, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 988 },
{ PROC_LINKS(luis_view_peek_in_parent_window, 0), false, "luis_view_peek_in_parent_window", 31, "view peek buffer in split window", 32, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1041 },
{ PROC_LINKS(luis_vim_string_matches, 0), true, "luis_vim_string_matches", 23, "Enter Command Mode", 18, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3084 },
{ PROC_LINKS(luis_write_newline, 0), false, "luis_write_newline", 18, "", 0, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 745 },
{ PROC_LINKS(luis_write_pointer_arrow, 0), false, "luis_write_pointer_arrow", 24, "", 0, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 741 },
{ PROC_LINKS(luis_write_tab, 0), false, "luis_write_tab", 14, "", 0, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 749 },
{ PROC_LINKS(luis_write_underscore, 0), false, "luis_write_underscore", 21, "", 0, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 737 },
...
{ PROC_LINKS(navigate_back, 0), false, "navigate_back", 13, "Jump back to previous view location", 35, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 898 },
{ PROC_LINKS(navigate_forward, 0), false, "navigate_forward", 16, "Jump back to next view location", 31, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 919 },
...
{ PROC_LINKS(open_file_in_10x, 0), false, "open_file_in_10x", 16, "Open current file in 10x", 24, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 102 },
...
{ PROC_LINKS(open_file_in_visual_studio, 0), false, "open_file_in_visual_studio", 26, "Open current file in visual studio", 34, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 44 },
...
{ PROC_LINKS(open_panel_hsplit, 0), false, "open_panel_hsplit", 17, "Create a new panel by horizontally splitting the active panel.", 62, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 391 },
{ PROC_LINKS(open_panel_vsplit, 0), false, "open_panel_vsplit", 17, "Create a new panel by vertically splitting the active panel.", 60, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 381 },
...
{ PROC_LINKS(reload_project, 0), false, "reload_project", 14, "Reload project.4coder", 21, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1629 },
...
{ PROC_LINKS(revert_buffer, 0), false, "revert_buffer", 13, "Revert buffer to contents on disk", 33, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 142 },
{ PROC_LINKS(save, 0), false, "save", 4, "Saves the current buffer.", 25, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 1798 },
{ PROC_LINKS(save_all_dirty_buffers, 0), false, "save_all_dirty_buffers", 22, "Saves all buffers marked dirty (showing the '*' indicator).", 59, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 463 },
...
{ PROC_LINKS(set_mode_to_notepad_like, 0), false, "set_mode_to_notepad_like", 24, "Sets the edit mode to Notepad like.", 35, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 508 },
{ PROC_LINKS(set_mode_to_original, 0), false, "set_mode_to_original", 20, "Sets the edit mode to 4coder original.", 38, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 502 },
...
{ PROC_LINKS(suppress_mouse, 0), false, "suppress_mouse", 14, "Hides the mouse and causes all mosue input (clicks, position, wheel) to be ignored.", 83, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 484 },
...
{ PROC_LINKS(toggle_fullscreen, 0), false, "toggle_fullscreen", 17, "Toggle fullscreen mode on or off.  The change(s) do not take effect until the next frame.", 89, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 538 },
{ PROC_LINKS(toggle_highlight_enclosing_scopes, 0), false, "toggle_highlight_enclosing_scopes", 33, "In code files scopes surrounding the cursor are highlighted with distinguishing colors.", 87, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 522 },
{ PROC_LINKS(toggle_highlight_line_at_cursor, 0), false, "toggle_highlight_line_at_cursor", 31, "Toggles the line highlight at the cursor.", 41, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 514 },
...
{ PROC_LINKS(toggle_mouse, 0), false, "toggle_mouse", 12, "Toggles the mouse suppression mode, see suppress_mouse and allow_mouse.", 71, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 496 },
{ PROC_LINKS(toggle_paren_matching_helper, 0), false, "toggle_paren_matching_helper", 28, "In code files matching parentheses pairs are colored with distinguishing colors.", 80, "D:\\work\\4ed\\code\\custom\\4coder_default_framework.cpp", 52, 530 },
...
{ PROC_LINKS(write_filename, 0), false, "write_filename", 14, "Write file name", 15, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 81 },
{ PROC_LINKS(write_filepath, 0), false, "write_filepath", 14, "Write file full path", 20, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 68 },
...
{ PROC_LINKS(write_text_input, 0), false, "write_text_input", 16, "Inserts whatever text was used to trigger this command.", 55, "D:\\work\\4ed\\code\\custom\\4coder_base_commands.cpp", 48, 106 },
...
static i32 fcoder_metacmd_ID_luis_peek_scopes = 142;
static i32 fcoder_metacmd_ID_luis_print_scope_variables = 143;
static i32 fcoder_metacmd_ID_luis_remove_space = 144;
static i32 fcoder_metacmd_ID_luis_remove_tab = 145;
static i32 fcoder_metacmd_ID_luis_reselect_selection = 146;
static i32 fcoder_metacmd_ID_luis_return = 147;
static i32 fcoder_metacmd_ID_luis_right_word = 148;
static i32 fcoder_metacmd_ID_luis_rsearch = 149;
static i32 fcoder_metacmd_ID_luis_scope_braces = 150;
static i32 fcoder_metacmd_ID_luis_select_line = 151;
static i32 fcoder_metacmd_ID_luis_select_scope_contents = 152;
static i32 fcoder_metacmd_ID_luis_select_surrounding_scope = 153;
static i32 fcoder_metacmd_ID_luis_select_surrounding_scope_maximal = 154;
static i32 fcoder_metacmd_ID_luis_select_word_under_cursor = 155;
static i32 fcoder_metacmd_ID_luis_set_mark = 156;
static i32 fcoder_metacmd_ID_luis_show_search_panel = 157;
static i32 fcoder_metacmd_ID_luis_startup = 158;
static i32 fcoder_metacmd_ID_luis_toggle_modal_mode = 159;
static i32 fcoder_metacmd_ID_luis_try_exit = 160;
static i32 fcoder_metacmd_ID_luis_view_input_handler = 161;
static i32 fcoder_metacmd_ID_luis_view_peek_as_split_window = 162;
static i32 fcoder_metacmd_ID_luis_view_peek_in_parent_window = 163;
static i32 fcoder_metacmd_ID_luis_vim_string_matches = 164;
static i32 fcoder_metacmd_ID_luis_write_newline = 165;
static i32 fcoder_metacmd_ID_luis_write_pointer_arrow = 166;
static i32 fcoder_metacmd_ID_luis_write_tab = 167;
static i32 fcoder_metacmd_ID_luis_write_underscore = 168;
static i32 fcoder_metacmd_ID_make_directory_query = 169;
static i32 fcoder_metacmd_ID_miblo_decrement_basic = 170;
static i32 fcoder_metacmd_ID_miblo_decrement_time_stamp = 171;
static i32 fcoder_metacmd_ID_miblo_decrement_time_stamp_minute = 172;
static i32 fcoder_metacmd_ID_miblo_increment_basic = 173;
static i32 fcoder_metacmd_ID_miblo_increment_time_stamp = 174;
static i32 fcoder_metacmd_ID_miblo_increment_time_stamp_minute = 175;
static i32 fcoder_metacmd_ID_mouse_wheel_change_face_size = 176;
static i32 fcoder_metacmd_ID_mouse_wheel_scroll = 177;
static i32 fcoder_metacmd_ID_move_down = 178;
static i32 fcoder_metacmd_ID_move_down_10 = 179;
static i32 fcoder_metacmd_ID_move_down_textual = 180;
static i32 fcoder_metacmd_ID_move_down_to_blank_line = 181;
static i32 fcoder_metacmd_ID_move_down_to_blank_line_end = 182;
static i32 fcoder_metacmd_ID_move_down_to_blank_line_skip_whitespace = 183;
static i32 fcoder_metacmd_ID_move_left = 184;
static i32 fcoder_metacmd_ID_move_left_alpha_numeric_boundary = 185;
static i32 fcoder_metacmd_ID_move_left_alpha_numeric_or_camel_boundary = 186;
static i32 fcoder_metacmd_ID_move_left_token_boundary = 187;
static i32 fcoder_metacmd_ID_move_left_whitespace_boundary = 188;
static i32 fcoder_metacmd_ID_move_left_whitespace_or_token_boundary = 189;
static i32 fcoder_metacmd_ID_move_line_down = 190;
static i32 fcoder_metacmd_ID_move_line_up = 191;
static i32 fcoder_metacmd_ID_move_right = 192;
static i32 fcoder_metacmd_ID_move_right_alpha_numeric_boundary = 193;
static i32 fcoder_metacmd_ID_move_right_alpha_numeric_or_camel_boundary = 194;
static i32 fcoder_metacmd_ID_move_right_token_boundary = 195;
static i32 fcoder_metacmd_ID_move_right_whitespace_boundary = 196;
static i32 fcoder_metacmd_ID_move_right_whitespace_or_token_boundary = 197;
static i32 fcoder_metacmd_ID_move_up = 198;
static i32 fcoder_metacmd_ID_move_up_10 = 199;
static i32 fcoder_metacmd_ID_move_up_to_blank_line = 200;
static i32 fcoder_metacmd_ID_move_up_to_blank_line_end = 201;
static i32 fcoder_metacmd_ID_move_up_to_blank_line_skip_whitespace = 202;
static i32 fcoder_metacmd_ID_multi_paste = 203;
static i32 fcoder_metacmd_ID_multi_paste_interactive = 204;
static i32 fcoder_metacmd_ID_multi_paste_interactive_quick = 205;
static i32 fcoder_metacmd_ID_music_start = 206;
static i32 fcoder_metacmd_ID_music_stop = 207;
static i32 fcoder_metacmd_ID_navigate_back = 208;
static i32 fcoder_metacmd_ID_navigate_forward = 209;
static i32 fcoder_metacmd_ID_open_all_code = 210;
static i32 fcoder_metacmd_ID_open_all_code_recursive = 211;
static i32 fcoder_metacmd_ID_open_file_in_10x = 212;
static i32 fcoder_metacmd_ID_open_file_in_quotes = 213;
static i32 fcoder_metacmd_ID_open_file_in_visual_studio = 214;
...
static i32 fcoder_metacmd_ID_reload_project = 260;
...
static i32 fcoder_metacmd_ID_revert_buffer = 268;
...
static i32 fcoder_metacmd_ID_show_file_in_explorer = 298;
...
static i32 fcoder_metacmd_ID_toggle_text_drop_shadow = 321;
static i32 fcoder_metacmd_ID_toggle_virtual_whitespace = 322;
static i32 fcoder_metacmd_ID_tutorial_maximize = 323;
static i32 fcoder_metacmd_ID_tutorial_minimize = 324;
static i32 fcoder_metacmd_ID_uncomment_line = 325;
static i32 fcoder_metacmd_ID_undo = 326;
static i32 fcoder_metacmd_ID_undo_all_buffers = 327;
static i32 fcoder_metacmd_ID_view_buffer_other_panel = 328;
static i32 fcoder_metacmd_ID_view_jump_list_with_lister = 329;
static i32 fcoder_metacmd_ID_word_complete = 330;
static i32 fcoder_metacmd_ID_word_complete_drop_down = 331;
static i32 fcoder_metacmd_ID_write_block = 332;
static i32 fcoder_metacmd_ID_write_filename = 333;
static i32 fcoder_metacmd_ID_write_filepath = 334;
