...
#define command_one_past_last_id 333
...
static Command_Metadata fcoder_metacmd_table[333] = {
...
{ PROC_LINKS(command_lister, 0), true, "command_lister", 14, "Opens an interactive list of all registered commands.", 53, "D:\\work\\4ed\\code\\custom\\4coder_lists.cpp", 40, 762 },
...
{ PROC_LINKS(emacs_kill_line, 0), false, "emacs_kill_line", 15, "Emacs-style kill line", 21, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 416 },
...
{ PROC_LINKS(interactive_kill_buffer, 0), true, "interactive_kill_buffer", 23, "Interactively kill an open buffer.", 34, "D:\\work\\4ed\\code\\custom\\4coder_lists.cpp", 40, 522 },
{ PROC_LINKS(interactive_new, 0), true, "interactive_new", 15, "Interactively creates a new file.", 33, "D:\\work\\4ed\\code\\custom\\4coder_lists.cpp", 40, 662 },
{ PROC_LINKS(interactive_open, 0), true, "interactive_open", 16, "Interactively opens a file.", 27, "D:\\work\\4ed\\code\\custom\\4coder_lists.cpp", 40, 716 },
{ PROC_LINKS(interactive_open_or_new, 0), true, "interactive_open_or_new", 23, "Interactively open a file out of the file system.", 49, "D:\\work\\4ed\\code\\custom\\4coder_lists.cpp", 40, 613 },
{ PROC_LINKS(interactive_switch_buffer, 0), true, "interactive_switch_buffer", 25, "Interactively switch to an open buffer.", 39, "D:\\work\\4ed\\code\\custom\\4coder_lists.cpp", 40, 512 },
...
{ PROC_LINKS(luis_add_space, 0), false, "luis_add_space", 14, "add space to line start", 23, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 279 },
{ PROC_LINKS(luis_add_tab, 0), false, "luis_add_tab", 12, "add tab to line start", 21, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 247 },
{ PROC_LINKS(luis_adjust_horizontal_view_toggle, 0), false, "luis_adjust_horizontal_view_toggle", 34, "Moves view horizontally to cursor x pos or back to leftmost of screen", 69, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 614 },
{ PROC_LINKS(luis_build, 0), false, "luis_build", 10, "build", 5, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 968 },
...
{ PROC_LINKS(luis_close_all_other_panels, 0), false, "luis_close_all_other_panels", 27, "Close all panels except active one", 34, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 741 },
{ PROC_LINKS(luis_close_current_panel, 0), false, "luis_close_current_panel", 24, "Close current panel", 19, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 751 },
{ PROC_LINKS(luis_close_peek_or_active_panel, 0), false, "luis_close_peek_or_active_panel", 31, "Close panel. Peek first.", 24, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 757 },
{ PROC_LINKS(luis_code_index_next, 0), false, "luis_code_index_next", 20, "next code index", 15, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 2437 },
{ PROC_LINKS(luis_code_index_prev, 0), false, "luis_code_index_prev", 20, "prev code index", 15, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 2456 },
{ PROC_LINKS(luis_end, 0), false, "luis_end", 8, "go end of visual line", 21, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 702 },
{ PROC_LINKS(luis_escape, 0), false, "luis_escape", 11, "escape key", 10, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 77 },
{ PROC_LINKS(luis_fsearch, 0), false, "luis_fsearch", 12, "search forwards", 15, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 2794 },
{ PROC_LINKS(luis_goto_next_jump, 0), false, "luis_goto_next_jump", 19, "If a buffer containing jump locations has been locked in, goes to the next jump in the buffer, skipping sub jump locations.", 123, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 938 },
{ PROC_LINKS(luis_goto_prev_jump, 0), false, "luis_goto_prev_jump", 19, "If a buffer containing jump locations has been locked in, goes to the previous jump in the buffer, skipping sub jump locations.", 127, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 954 },
{ PROC_LINKS(luis_home, 0), false, "luis_home", 9, "go start of visual line", 23, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 107 },
{ PROC_LINKS(luis_horizontal_mouse_wheel_scroll, 0), false, "luis_horizontal_mouse_wheel_scroll", 34, "Reads the scroll wheel value from the mouse state and scrolls accordingly.", 74, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 638 },
{ PROC_LINKS(luis_indent_range, 0), false, "luis_indent_range", 17, "indent_range", 12, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 232 },
{ PROC_LINKS(luis_interactive_open_or_new, 0), false, "luis_interactive_open_or_new", 28, "open in new in same tab", 23, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 93 },
{ PROC_LINKS(luis_left_word, 0), false, "luis_left_word", 14, "move left", 9, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 115 },
{ PROC_LINKS(luis_list_functions_all_buffers, 0), false, "luis_list_functions_all_buffers", 31, "Show code indexes for all buffer", 32, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1481 },
{ PROC_LINKS(luis_list_nests_this_buffer, 0), false, "luis_list_nests_this_buffer", 27, "Show code nests for this buffer", 31, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1062 },
{ PROC_LINKS(luis_list_notes_all_buffers, 0), false, "luis_list_notes_all_buffers", 27, "Show code indexes for all buffer", 32, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1378 },
{ PROC_LINKS(luis_list_notes_no_duplicates, 0), false, "luis_list_notes_no_duplicates", 29, "Show code indexes for all buffer with no duplicates", 51, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1626 },
{ PROC_LINKS(luis_list_notes_this_buffer, 0), false, "luis_list_notes_this_buffer", 27, "Show code indexes for buffer", 28, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1130 },
{ PROC_LINKS(luis_matching_file_cpp, 0), false, "luis_matching_file_cpp", 22, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 829 },
{ PROC_LINKS(luis_matching_file_cpp_same_buffer, 0), false, "luis_matching_file_cpp_same_buffer", 34, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 819 },
{ PROC_LINKS(luis_multiline_comment_toggle, 0), false, "luis_multiline_comment_toggle", 29, "Deletes all whitespace at cursor, going backwards", 49, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 653 },
{ PROC_LINKS(luis_open_up_braces, 0), false, "luis_open_up_braces", 19, "open braces up", 14, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 206 },
{ PROC_LINKS(luis_print_scope_variables, 0), false, "luis_print_scope_variables", 26, "print scope variables", 21, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1781 },
{ PROC_LINKS(luis_remove_space, 0), false, "luis_remove_space", 17, "remove space from line start", 28, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 352 },
{ PROC_LINKS(luis_remove_tab, 0), false, "luis_remove_tab", 15, "remove tab from line start", 26, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 303 },
{ PROC_LINKS(luis_return, 0), false, "luis_return", 11, "If the buffer in the active view is writable, inserts a character, otherwise performs goto_jump_at_cursor.", 106, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 843 },
{ PROC_LINKS(luis_right_word, 0), false, "luis_right_word", 15, "move right", 10, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 122 },
{ PROC_LINKS(luis_rsearch, 0), false, "luis_rsearch", 12, "search backwards", 16, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 2801 },
{ PROC_LINKS(luis_scope_braces, 0), false, "luis_scope_braces", 17, "writes {}", 9, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 157 },
{ PROC_LINKS(luis_select_line, 0), false, "luis_select_line", 16, "go end of visual line", 21, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 406 },
{ PROC_LINKS(luis_select_surrounding_scope, 0), false, "luis_select_surrounding_scope", 29, "select surrounding scope", 24, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 469 },
{ PROC_LINKS(luis_select_surrounding_scope_maximal, 0), false, "luis_select_surrounding_scope_maximal", 37, "select surrounding scope", 24, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 576 },
{ PROC_LINKS(luis_set_mark, 0), false, "luis_set_mark", 13, "set mark", 8, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 136 },
{ PROC_LINKS(luis_show_search_panel, 0), false, "luis_show_search_panel", 22, "Enter Command Mode", 18, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 2549 },
...
{ PROC_LINKS(luis_toggle_modal_mode, 0), false, "luis_toggle_modal_mode", 22, "Toggles modal mode", 18, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 83 },
{ PROC_LINKS(luis_try_exit, 0), false, "luis_try_exit", 13, "Default command for responding to a try-exit event", 50, "D:\\work\\4ed\\code\\custom\\luis_hooks.cpp", 38, 982 },
...
{ PROC_LINKS(luis_view_peek_as_split_window, 0), false, "luis_view_peek_as_split_window", 30, "view peek buffer in split window", 32, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 494 },
{ PROC_LINKS(luis_view_peek_in_parent_window, 0), false, "luis_view_peek_in_parent_window", 31, "view peek buffer in split window", 32, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 547 },
{ PROC_LINKS(luis_vim_string_matches, 0), true, "luis_vim_string_matches", 23, "Enter Command Mode", 18, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 2517 },
{ PROC_LINKS(luis_write_newline, 0), false, "luis_write_newline", 18, "", 0, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 603 },
{ PROC_LINKS(luis_write_pointer_arrow, 0), false, "luis_write_pointer_arrow", 24, "", 0, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 599 },
{ PROC_LINKS(luis_write_tab, 0), false, "luis_write_tab", 14, "", 0, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 607 },
{ PROC_LINKS(luis_write_underscore, 0), false, "luis_write_underscore", 21, "", 0, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 595 },
...
{ PROC_LINKS(open_file_in_10x, 0), false, "open_file_in_10x", 16, "Open current file in 10x", 24, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 54 },
...
{ PROC_LINKS(open_file_in_visual_studio, 0), false, "open_file_in_visual_studio", 26, "Open current file in visual studio", 34, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 30 },
...
{ PROC_LINKS(reload_project, 0), false, "reload_project", 14, "Reload project.4coder", 21, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1310 },
...
{ PROC_LINKS(show_file_in_explorer, 0), false, "show_file_in_explorer", 21, "Opens file explorer in hot directory", 36, "D:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 12 },
...
{ PROC_LINKS(theme_lister, 0), true, "theme_lister", 12, "Opens an interactive list of all registered themes.", 51, "D:\\work\\4ed\\code\\custom\\4coder_lists.cpp", 40, 786 },
...
{ PROC_LINKS(vim_list_all_functions_current_buffer_lister, 0), true, "vim_list_all_functions_current_buffer_lister", 44, "Creates a lister of locations that look like function definitions and declarations in the buffer.", 97, "D:\\work\\4ed\\code\\custom\\4coder_vim_lists.cpp", 44, 979 },
{ PROC_LINKS(vim_proj_cmd_lister, 0), true, "vim_proj_cmd_lister", 19, "Opens an interactive list of all project commands.", 50, "D:\\work\\4ed\\code\\custom\\4coder_vim_lists.cpp", 44, 998 },
{ PROC_LINKS(vim_switch_file_or_buffer, 0), true, "vim_switch_file_or_buffer", 25, "Interactively open a file out of the file system.", 49, "D:\\work\\4ed\\code\\custom\\4coder_vim_lists.cpp", 44, 855 },
...
static i32 fcoder_metacmd_ID_emacs_kill_line = 49;
...
static i32 fcoder_metacmd_ID_luis_add_space = 105;
static i32 fcoder_metacmd_ID_luis_add_tab = 106;
static i32 fcoder_metacmd_ID_luis_adjust_horizontal_view_toggle = 107;
static i32 fcoder_metacmd_ID_luis_build = 108;
static i32 fcoder_metacmd_ID_luis_center_view_top = 109;
static i32 fcoder_metacmd_ID_luis_close_all_other_panels = 110;
static i32 fcoder_metacmd_ID_luis_close_current_panel = 111;
static i32 fcoder_metacmd_ID_luis_close_peek_or_active_panel = 112;
static i32 fcoder_metacmd_ID_luis_code_index_next = 113;
static i32 fcoder_metacmd_ID_luis_code_index_prev = 114;
static i32 fcoder_metacmd_ID_luis_end = 115;
static i32 fcoder_metacmd_ID_luis_escape = 116;
static i32 fcoder_metacmd_ID_luis_fsearch = 117;
static i32 fcoder_metacmd_ID_luis_goto_next_jump = 118;
static i32 fcoder_metacmd_ID_luis_goto_prev_jump = 119;
static i32 fcoder_metacmd_ID_luis_home = 120;
static i32 fcoder_metacmd_ID_luis_horizontal_mouse_wheel_scroll = 121;
static i32 fcoder_metacmd_ID_luis_indent_range = 122;
static i32 fcoder_metacmd_ID_luis_interactive_open_or_new = 123;
static i32 fcoder_metacmd_ID_luis_left_word = 124;
static i32 fcoder_metacmd_ID_luis_list_functions_all_buffers = 125;
static i32 fcoder_metacmd_ID_luis_list_nests_this_buffer = 126;
static i32 fcoder_metacmd_ID_luis_list_notes_all_buffers = 127;
static i32 fcoder_metacmd_ID_luis_list_notes_no_duplicates = 128;
static i32 fcoder_metacmd_ID_luis_list_notes_this_buffer = 129;
static i32 fcoder_metacmd_ID_luis_matching_file_cpp = 130;
static i32 fcoder_metacmd_ID_luis_matching_file_cpp_same_buffer = 131;
static i32 fcoder_metacmd_ID_luis_multiline_comment_toggle = 132;
static i32 fcoder_metacmd_ID_luis_open_up_braces = 133;
static i32 fcoder_metacmd_ID_luis_print_scope_variables = 134;
static i32 fcoder_metacmd_ID_luis_remove_space = 135;
static i32 fcoder_metacmd_ID_luis_remove_tab = 136;
static i32 fcoder_metacmd_ID_luis_return = 137;
static i32 fcoder_metacmd_ID_luis_right_word = 138;
static i32 fcoder_metacmd_ID_luis_rsearch = 139;
static i32 fcoder_metacmd_ID_luis_scope_braces = 140;
static i32 fcoder_metacmd_ID_luis_select_line = 141;
static i32 fcoder_metacmd_ID_luis_select_surrounding_scope = 142;
static i32 fcoder_metacmd_ID_luis_select_surrounding_scope_maximal = 143;
static i32 fcoder_metacmd_ID_luis_set_mark = 144;
static i32 fcoder_metacmd_ID_luis_show_search_panel = 145;
static i32 fcoder_metacmd_ID_luis_startup = 146;
static i32 fcoder_metacmd_ID_luis_toggle_modal_mode = 147;
static i32 fcoder_metacmd_ID_luis_try_exit = 148;
static i32 fcoder_metacmd_ID_luis_view_input_handler = 149;
static i32 fcoder_metacmd_ID_luis_view_peek_as_split_window = 150;
static i32 fcoder_metacmd_ID_luis_view_peek_in_parent_window = 151;
static i32 fcoder_metacmd_ID_luis_vim_string_matches = 152;
static i32 fcoder_metacmd_ID_luis_write_newline = 153;
static i32 fcoder_metacmd_ID_luis_write_pointer_arrow = 154;
static i32 fcoder_metacmd_ID_luis_write_tab = 155;
static i32 fcoder_metacmd_ID_luis_write_underscore = 156;
static i32 fcoder_metacmd_ID_make_directory_query = 157;
static i32 fcoder_metacmd_ID_miblo_decrement_basic = 158;
static i32 fcoder_metacmd_ID_miblo_decrement_time_stamp = 159;
static i32 fcoder_metacmd_ID_miblo_decrement_time_stamp_minute = 160;
static i32 fcoder_metacmd_ID_miblo_increment_basic = 161;
static i32 fcoder_metacmd_ID_miblo_increment_time_stamp = 162;
static i32 fcoder_metacmd_ID_miblo_increment_time_stamp_minute = 163;
static i32 fcoder_metacmd_ID_mouse_wheel_change_face_size = 164;
static i32 fcoder_metacmd_ID_mouse_wheel_scroll = 165;
static i32 fcoder_metacmd_ID_move_down = 166;
static i32 fcoder_metacmd_ID_move_down_10 = 167;
static i32 fcoder_metacmd_ID_move_down_textual = 168;
static i32 fcoder_metacmd_ID_move_down_to_blank_line = 169;
static i32 fcoder_metacmd_ID_move_down_to_blank_line_end = 170;
static i32 fcoder_metacmd_ID_move_down_to_blank_line_skip_whitespace = 171;
static i32 fcoder_metacmd_ID_move_left = 172;
static i32 fcoder_metacmd_ID_move_left_alpha_numeric_boundary = 173;
static i32 fcoder_metacmd_ID_move_left_alpha_numeric_or_camel_boundary = 174;
static i32 fcoder_metacmd_ID_move_left_token_boundary = 175;
static i32 fcoder_metacmd_ID_move_left_whitespace_boundary = 176;
static i32 fcoder_metacmd_ID_move_left_whitespace_or_token_boundary = 177;
static i32 fcoder_metacmd_ID_move_line_down = 178;
static i32 fcoder_metacmd_ID_move_line_up = 179;
static i32 fcoder_metacmd_ID_move_right = 180;
static i32 fcoder_metacmd_ID_move_right_alpha_numeric_boundary = 181;
static i32 fcoder_metacmd_ID_move_right_alpha_numeric_or_camel_boundary = 182;
static i32 fcoder_metacmd_ID_move_right_token_boundary = 183;
static i32 fcoder_metacmd_ID_move_right_whitespace_boundary = 184;
static i32 fcoder_metacmd_ID_move_right_whitespace_or_token_boundary = 185;
static i32 fcoder_metacmd_ID_move_up = 186;
static i32 fcoder_metacmd_ID_move_up_10 = 187;
static i32 fcoder_metacmd_ID_move_up_to_blank_line = 188;
static i32 fcoder_metacmd_ID_move_up_to_blank_line_end = 189;
static i32 fcoder_metacmd_ID_move_up_to_blank_line_skip_whitespace = 190;
static i32 fcoder_metacmd_ID_multi_paste = 191;
static i32 fcoder_metacmd_ID_multi_paste_interactive = 192;
static i32 fcoder_metacmd_ID_multi_paste_interactive_quick = 193;
static i32 fcoder_metacmd_ID_music_start = 194;
static i32 fcoder_metacmd_ID_music_stop = 195;
static i32 fcoder_metacmd_ID_open_all_code = 196;
static i32 fcoder_metacmd_ID_open_all_code_recursive = 197;
static i32 fcoder_metacmd_ID_open_file_in_10x = 198;
static i32 fcoder_metacmd_ID_open_file_in_quotes = 199;
static i32 fcoder_metacmd_ID_open_file_in_visual_studio = 200;
static i32 fcoder_metacmd_ID_open_in_other = 201;
static i32 fcoder_metacmd_ID_open_long_braces = 202;
static i32 fcoder_metacmd_ID_open_long_braces_break = 203;
static i32 fcoder_metacmd_ID_open_long_braces_semicolon = 204;
static i32 fcoder_metacmd_ID_open_matching_file_cpp = 205;
static i32 fcoder_metacmd_ID_open_panel_hsplit = 206;
static i32 fcoder_metacmd_ID_open_panel_vsplit = 207;
static i32 fcoder_metacmd_ID_page_down = 208;
static i32 fcoder_metacmd_ID_page_up = 209;
static i32 fcoder_metacmd_ID_paste = 210;
static i32 fcoder_metacmd_ID_paste_and_indent = 211;
static i32 fcoder_metacmd_ID_paste_next = 212;
static i32 fcoder_metacmd_ID_paste_next_and_indent = 213;
static i32 fcoder_metacmd_ID_place_in_scope = 214;
static i32 fcoder_metacmd_ID_play_with_a_counter = 215;
static i32 fcoder_metacmd_ID_profile_clear = 216;
static i32 fcoder_metacmd_ID_profile_disable = 217;
static i32 fcoder_metacmd_ID_profile_enable = 218;
static i32 fcoder_metacmd_ID_profile_inspect = 219;
static i32 fcoder_metacmd_ID_project_command_F1 = 220;
static i32 fcoder_metacmd_ID_project_command_F10 = 221;
static i32 fcoder_metacmd_ID_project_command_F11 = 222;
static i32 fcoder_metacmd_ID_project_command_F12 = 223;
static i32 fcoder_metacmd_ID_project_command_F13 = 224;
static i32 fcoder_metacmd_ID_project_command_F14 = 225;
static i32 fcoder_metacmd_ID_project_command_F15 = 226;
static i32 fcoder_metacmd_ID_project_command_F16 = 227;
static i32 fcoder_metacmd_ID_project_command_F2 = 228;
static i32 fcoder_metacmd_ID_project_command_F3 = 229;
static i32 fcoder_metacmd_ID_project_command_F4 = 230;
static i32 fcoder_metacmd_ID_project_command_F5 = 231;
static i32 fcoder_metacmd_ID_project_command_F6 = 232;
static i32 fcoder_metacmd_ID_project_command_F7 = 233;
static i32 fcoder_metacmd_ID_project_command_F8 = 234;
static i32 fcoder_metacmd_ID_project_command_F9 = 235;
static i32 fcoder_metacmd_ID_project_command_lister = 236;
static i32 fcoder_metacmd_ID_project_fkey_command = 237;
static i32 fcoder_metacmd_ID_project_go_to_root_directory = 238;
static i32 fcoder_metacmd_ID_project_reprint = 239;
static i32 fcoder_metacmd_ID_query_replace = 240;
static i32 fcoder_metacmd_ID_query_replace_identifier = 241;
static i32 fcoder_metacmd_ID_query_replace_selection = 242;
static i32 fcoder_metacmd_ID_quick_swap_buffer = 243;
static i32 fcoder_metacmd_ID_redo = 244;
static i32 fcoder_metacmd_ID_redo_all_buffers = 245;
static i32 fcoder_metacmd_ID_reload_project = 246;
...
static i32 fcoder_metacmd_ID_show_file_in_explorer = 283;
static i32 fcoder_metacmd_ID_show_filebar = 284;
static i32 fcoder_metacmd_ID_show_scrollbar = 285;
static i32 fcoder_metacmd_ID_show_the_log_graph = 286;
static i32 fcoder_metacmd_ID_snipe_backward_whitespace_or_token_boundary = 287;
static i32 fcoder_metacmd_ID_snipe_forward_whitespace_or_token_boundary = 288;
static i32 fcoder_metacmd_ID_snippet_lister = 289;
static i32 fcoder_metacmd_ID_string_repeat = 290;
static i32 fcoder_metacmd_ID_suppress_mouse = 291;
static i32 fcoder_metacmd_ID_swap_panels = 292;
static i32 fcoder_metacmd_ID_theme_lister = 293;
static i32 fcoder_metacmd_ID_to_lowercase = 294;
static i32 fcoder_metacmd_ID_to_uppercase = 295;
...
static i32 fcoder_metacmd_ID_toggle_highlight_enclosing_scopes = 299;
static i32 fcoder_metacmd_ID_toggle_highlight_line_at_cursor = 300;
static i32 fcoder_metacmd_ID_toggle_line_numbers = 301;
static i32 fcoder_metacmd_ID_toggle_line_wrap = 302;
static i32 fcoder_metacmd_ID_toggle_mouse = 303;
static i32 fcoder_metacmd_ID_toggle_paren_matching_helper = 304;
static i32 fcoder_metacmd_ID_toggle_show_whitespace = 305;
static i32 fcoder_metacmd_ID_toggle_text_drop_shadow = 306;
...
static i32 fcoder_metacmd_ID_vim_command_mode = 315;
static i32 fcoder_metacmd_ID_vim_interactive_open_or_new = 316;
static i32 fcoder_metacmd_ID_vim_list_all_functions_current_buffer_lister = 317;
static i32 fcoder_metacmd_ID_vim_proj_cmd_lister = 318;
static i32 fcoder_metacmd_ID_vim_switch_file_or_buffer = 319;
static i32 fcoder_metacmd_ID_vim_switch_lister = 320;
static i32 fcoder_metacmd_ID_vim_theme_lister = 321;
static i32 fcoder_metacmd_ID_word_complete = 322;
static i32 fcoder_metacmd_ID_word_complete_drop_down = 323;
static i32 fcoder_metacmd_ID_write_block = 324;
static i32 fcoder_metacmd_ID_write_hack = 325;
static i32 fcoder_metacmd_ID_write_note = 326;
static i32 fcoder_metacmd_ID_write_space = 327;
static i32 fcoder_metacmd_ID_write_text_and_auto_indent = 328;
static i32 fcoder_metacmd_ID_write_text_input = 329;
static i32 fcoder_metacmd_ID_write_todo = 330;
static i32 fcoder_metacmd_ID_write_underscore = 331;
static i32 fcoder_metacmd_ID_write_zero_struct = 332;
#endif
