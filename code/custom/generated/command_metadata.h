...
#define command_one_past_last_id 337
...
static Command_Metadata fcoder_metacmd_table[337] = {
...
{ PROC_LINKS(ctrl_tab_switch_buffer, 0), true, "ctrl_tab_switch_buffer", 22, "Alt-tab behaviour way of switching buffer", 41, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 2148 },
...
{ PROC_LINKS(luis_adjust_horizontal_view_toggle, 0), false, "luis_adjust_horizontal_view_toggle", 34, "Moves view horizontally to cursor x pos or back to leftmost of screen", 69, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 797 },
...
{ PROC_LINKS(luis_build, 0), false, "luis_build", 10, "build", 5, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1160 },
...
{ PROC_LINKS(luis_close_all_other_panels, 0), false, "luis_close_all_other_panels", 27, "Close all panels except active one", 34, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 933 },
{ PROC_LINKS(luis_close_current_panel, 0), false, "luis_close_current_panel", 24, "Close current panel", 19, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 943 },
{ PROC_LINKS(luis_close_peek_or_active_panel, 0), false, "luis_close_peek_or_active_panel", 31, "Close panel. Peek first.", 24, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 949 },
{ PROC_LINKS(luis_code_index_next, 0), false, "luis_code_index_next", 20, "next code index", 15, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3165 },
{ PROC_LINKS(luis_code_index_prev, 0), false, "luis_code_index_prev", 20, "prev code index", 15, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3184 },
...
{ PROC_LINKS(luis_end, 0), false, "luis_end", 8, "go end of visual line", 21, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 894 },
{ PROC_LINKS(luis_escape, 0), false, "luis_escape", 11, "escape key", 10, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 93 },
{ PROC_LINKS(luis_fsearch, 0), false, "luis_fsearch", 12, "search forwards", 15, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3528 },
{ PROC_LINKS(luis_goto_next_jump, 0), false, "luis_goto_next_jump", 19, "If a buffer containing jump locations has been locked in, goes to the next jump in the buffer, skipping sub jump locations.", 123, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1130 },
{ PROC_LINKS(luis_goto_prev_jump, 0), false, "luis_goto_prev_jump", 19, "If a buffer containing jump locations has been locked in, goes to the previous jump in the buffer, skipping sub jump locations.", 127, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1146 },
{ PROC_LINKS(luis_home, 0), false, "luis_home", 9, "go start of visual line", 23, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 126 },
{ PROC_LINKS(luis_horizontal_mouse_wheel_scroll, 0), false, "luis_horizontal_mouse_wheel_scroll", 34, "Reads the scroll wheel value from the mouse state and scrolls accordingly.", 74, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 821 },
...
{ PROC_LINKS(luis_list_functions_all_buffers, 0), false, "luis_list_functions_all_buffers", 31, "Show code indexes for all buffer", 32, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1694 },
{ PROC_LINKS(luis_list_nests_this_buffer, 0), false, "luis_list_nests_this_buffer", 27, "Show code nests for this buffer", 31, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1275 },
{ PROC_LINKS(luis_list_notes_all_buffers, 0), false, "luis_list_notes_all_buffers", 27, "Show code indexes for all buffer", 32, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1591 },
{ PROC_LINKS(luis_list_notes_no_duplicates, 0), false, "luis_list_notes_no_duplicates", 29, "Show code indexes for all buffer with no duplicates", 51, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1840 },
{ PROC_LINKS(luis_list_notes_this_buffer, 0), false, "luis_list_notes_this_buffer", 27, "Show code indexes for buffer", 28, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1343 },
{ PROC_LINKS(luis_matching_file_cpp, 0), false, "luis_matching_file_cpp", 22, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1021 },
{ PROC_LINKS(luis_matching_file_cpp_same_buffer, 0), false, "luis_matching_file_cpp_same_buffer", 34, "If the current file is a *.cpp or *.h, attempts to open the corresponding *.h or *.cpp file in the other view.", 110, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1011 },
{ PROC_LINKS(luis_multiline_comment_toggle, 0), false, "luis_multiline_comment_toggle", 29, "Deletes all whitespace at cursor, going backwards", 49, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 836 },
{ PROC_LINKS(luis_open_build_panel, 0), false, "luis_open_build_panel", 21, "open build panel", 16, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1202 },
...
{ PROC_LINKS(luis_print_scope_variables, 0), false, "luis_print_scope_variables", 26, "print scope variables", 21, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1997 },
...
{ PROC_LINKS(luis_return, 0), false, "luis_return", 11, "If the buffer in the active view is writable, inserts a character, otherwise performs goto_jump_at_cursor.", 106, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1035 },
{ PROC_LINKS(luis_right_word, 0), false, "luis_right_word", 15, "move right", 10, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 141 },
{ PROC_LINKS(luis_rsearch, 0), false, "luis_rsearch", 12, "search backwards", 16, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3535 },
...
{ PROC_LINKS(luis_select_surrounding_scope_maximal, 0), false, "luis_select_surrounding_scope_maximal", 37, "select surrounding scope", 24, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 759 },
...
{ PROC_LINKS(luis_show_search_panel, 0), false, "luis_show_search_panel", 22, "Enter Command Mode", 18, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3278 },
...
{ PROC_LINKS(luis_try_exit, 0), false, "luis_try_exit", 13, "Default command for responding to a try-exit event", 50, "d:\\work\\4ed\\code\\custom\\luis_hooks.cpp", 38, 1039 },
...
{ PROC_LINKS(luis_view_peek_as_split_window, 0), false, "luis_view_peek_as_split_window", 30, "view peek buffer in split window", 32, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 677 },
{ PROC_LINKS(luis_view_peek_in_parent_window, 0), false, "luis_view_peek_in_parent_window", 31, "view peek buffer in split window", 32, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 730 },
{ PROC_LINKS(luis_vim_string_matches, 0), true, "luis_vim_string_matches", 23, "Enter Command Mode", 18, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 3245 },
{ PROC_LINKS(luis_write_newline, 0), false, "luis_write_newline", 18, "", 0, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 786 },
{ PROC_LINKS(luis_write_pointer_arrow, 0), false, "luis_write_pointer_arrow", 24, "", 0, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 782 },
{ PROC_LINKS(luis_write_tab, 0), false, "luis_write_tab", 14, "", 0, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 790 },
{ PROC_LINKS(luis_write_underscore, 0), false, "luis_write_underscore", 21, "", 0, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 778 },
...
{ PROC_LINKS(reload_project, 0), false, "reload_project", 14, "Reload project.4coder", 21, "d:\\work\\4ed\\code\\custom\\luis_commands.cpp", 41, 1523 },
...
static i32 fcoder_metacmd_ID_luis_close_peek_or_active_panel = 117;
...
static i32 fcoder_metacmd_ID_open_all_code = 207;
static i32 fcoder_metacmd_ID_open_all_code_recursive = 208;
static i32 fcoder_metacmd_ID_open_file_in_10x = 209;
static i32 fcoder_metacmd_ID_open_file_in_quotes = 210;
static i32 fcoder_metacmd_ID_open_file_in_visual_studio = 211;
static i32 fcoder_metacmd_ID_open_in_other = 212;
static i32 fcoder_metacmd_ID_open_long_braces = 213;
static i32 fcoder_metacmd_ID_open_long_braces_break = 214;
static i32 fcoder_metacmd_ID_open_long_braces_semicolon = 215;
static i32 fcoder_metacmd_ID_open_matching_file_cpp = 216;
static i32 fcoder_metacmd_ID_open_panel_hsplit = 217;
static i32 fcoder_metacmd_ID_open_panel_vsplit = 218;
static i32 fcoder_metacmd_ID_page_down = 219;
static i32 fcoder_metacmd_ID_page_up = 220;
static i32 fcoder_metacmd_ID_paste = 221;
static i32 fcoder_metacmd_ID_paste_and_indent = 222;
static i32 fcoder_metacmd_ID_paste_next = 223;
static i32 fcoder_metacmd_ID_paste_next_and_indent = 224;
static i32 fcoder_metacmd_ID_place_in_scope = 225;
static i32 fcoder_metacmd_ID_play_with_a_counter = 226;
static i32 fcoder_metacmd_ID_profile_clear = 227;
static i32 fcoder_metacmd_ID_profile_disable = 228;
static i32 fcoder_metacmd_ID_profile_enable = 229;
static i32 fcoder_metacmd_ID_profile_inspect = 230;
static i32 fcoder_metacmd_ID_project_command_F1 = 231;
static i32 fcoder_metacmd_ID_project_command_F10 = 232;
static i32 fcoder_metacmd_ID_project_command_F11 = 233;
static i32 fcoder_metacmd_ID_project_command_F12 = 234;
static i32 fcoder_metacmd_ID_project_command_F13 = 235;
static i32 fcoder_metacmd_ID_project_command_F14 = 236;
static i32 fcoder_metacmd_ID_project_command_F15 = 237;
static i32 fcoder_metacmd_ID_project_command_F16 = 238;
static i32 fcoder_metacmd_ID_project_command_F2 = 239;
static i32 fcoder_metacmd_ID_project_command_F3 = 240;
static i32 fcoder_metacmd_ID_project_command_F4 = 241;
static i32 fcoder_metacmd_ID_project_command_F5 = 242;
static i32 fcoder_metacmd_ID_project_command_F6 = 243;
static i32 fcoder_metacmd_ID_project_command_F7 = 244;
static i32 fcoder_metacmd_ID_project_command_F8 = 245;
static i32 fcoder_metacmd_ID_project_command_F9 = 246;
static i32 fcoder_metacmd_ID_project_command_lister = 247;
static i32 fcoder_metacmd_ID_project_fkey_command = 248;
static i32 fcoder_metacmd_ID_project_go_to_root_directory = 249;
static i32 fcoder_metacmd_ID_project_reprint = 250;
static i32 fcoder_metacmd_ID_query_replace = 251;
static i32 fcoder_metacmd_ID_query_replace_identifier = 252;
static i32 fcoder_metacmd_ID_query_replace_selection = 253;
static i32 fcoder_metacmd_ID_quick_swap_buffer = 254;
static i32 fcoder_metacmd_ID_redo = 255;
static i32 fcoder_metacmd_ID_redo_all_buffers = 256;
static i32 fcoder_metacmd_ID_reload_project = 257;
static i32 fcoder_metacmd_ID_rename_file_query = 258;
static i32 fcoder_metacmd_ID_reopen = 259;
static i32 fcoder_metacmd_ID_replace_in_all_buffers = 260;
static i32 fcoder_metacmd_ID_replace_in_buffer = 261;
static i32 fcoder_metacmd_ID_replace_in_range = 262;
static i32 fcoder_metacmd_ID_reverse_search = 263;
static i32 fcoder_metacmd_ID_reverse_search_identifier = 264;
static i32 fcoder_metacmd_ID_save = 265;
static i32 fcoder_metacmd_ID_save_all_dirty_buffers = 266;
static i32 fcoder_metacmd_ID_save_to_query = 267;
static i32 fcoder_metacmd_ID_search = 268;
static i32 fcoder_metacmd_ID_search_identifier = 269;
static i32 fcoder_metacmd_ID_seek_beginning_of_line = 270;
static i32 fcoder_metacmd_ID_seek_beginning_of_textual_line = 271;
static i32 fcoder_metacmd_ID_seek_end_of_line = 272;
static i32 fcoder_metacmd_ID_seek_end_of_textual_line = 273;
static i32 fcoder_metacmd_ID_select_all = 274;
static i32 fcoder_metacmd_ID_select_next_scope_absolute = 275;
static i32 fcoder_metacmd_ID_select_next_scope_after_current = 276;
static i32 fcoder_metacmd_ID_select_prev_scope_absolute = 277;
static i32 fcoder_metacmd_ID_select_prev_top_most_scope = 278;
static i32 fcoder_metacmd_ID_select_surrounding_scope = 279;
static i32 fcoder_metacmd_ID_select_surrounding_scope_maximal = 280;
static i32 fcoder_metacmd_ID_set_eol_mode_from_contents = 281;
static i32 fcoder_metacmd_ID_set_eol_mode_to_binary = 282;
static i32 fcoder_metacmd_ID_set_eol_mode_to_crlf = 283;
static i32 fcoder_metacmd_ID_set_eol_mode_to_lf = 284;
static i32 fcoder_metacmd_ID_set_face_size = 285;
static i32 fcoder_metacmd_ID_set_face_size_this_buffer = 286;
static i32 fcoder_metacmd_ID_set_mark = 287;
static i32 fcoder_metacmd_ID_set_mode_to_notepad_like = 288;
static i32 fcoder_metacmd_ID_set_mode_to_original = 289;
static i32 fcoder_metacmd_ID_setup_build_bat = 290;
static i32 fcoder_metacmd_ID_setup_build_bat_and_sh = 291;
static i32 fcoder_metacmd_ID_setup_build_sh = 292;
static i32 fcoder_metacmd_ID_setup_new_project = 293;
static i32 fcoder_metacmd_ID_show_file_in_explorer = 294;
...
static i32 fcoder_metacmd_ID_theme_lister = 304;
static i32 fcoder_metacmd_ID_to_lowercase = 305;
static i32 fcoder_metacmd_ID_to_uppercase = 306;
static i32 fcoder_metacmd_ID_toggle_filebar = 307;
static i32 fcoder_metacmd_ID_toggle_fps_meter = 308;
static i32 fcoder_metacmd_ID_toggle_fullscreen = 309;
static i32 fcoder_metacmd_ID_toggle_highlight_enclosing_scopes = 310;
static i32 fcoder_metacmd_ID_toggle_highlight_line_at_cursor = 311;
static i32 fcoder_metacmd_ID_toggle_line_numbers = 312;
static i32 fcoder_metacmd_ID_toggle_line_wrap = 313;
static i32 fcoder_metacmd_ID_toggle_mouse = 314;
static i32 fcoder_metacmd_ID_toggle_paren_matching_helper = 315;
static i32 fcoder_metacmd_ID_toggle_show_whitespace = 316;
static i32 fcoder_metacmd_ID_toggle_text_drop_shadow = 317;
static i32 fcoder_metacmd_ID_toggle_virtual_whitespace = 318;
static i32 fcoder_metacmd_ID_tutorial_maximize = 319;
static i32 fcoder_metacmd_ID_tutorial_minimize = 320;
static i32 fcoder_metacmd_ID_uncomment_line = 321;
static i32 fcoder_metacmd_ID_undo = 322;
static i32 fcoder_metacmd_ID_undo_all_buffers = 323;
static i32 fcoder_metacmd_ID_view_buffer_other_panel = 324;
static i32 fcoder_metacmd_ID_view_jump_list_with_lister = 325;
static i32 fcoder_metacmd_ID_word_complete = 326;
static i32 fcoder_metacmd_ID_word_complete_drop_down = 327;
static i32 fcoder_metacmd_ID_write_block = 328;
static i32 fcoder_metacmd_ID_write_hack = 329;
static i32 fcoder_metacmd_ID_write_note = 330;
static i32 fcoder_metacmd_ID_write_space = 331;
static i32 fcoder_metacmd_ID_write_text_and_auto_indent = 332;
static i32 fcoder_metacmd_ID_write_text_input = 333;
static i32 fcoder_metacmd_ID_write_todo = 334;
static i32 fcoder_metacmd_ID_write_underscore = 335;
static i32 fcoder_metacmd_ID_write_zero_struct = 336;
#endif
