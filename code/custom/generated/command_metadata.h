...
#define command_one_past_last_id 308
...
static Command_Metadata fcoder_metacmd_table[308] = {
...
{ PROC_LINKS(toggle_virtual_whitespace, 0), false, "toggle_virtual_whitespace", 25, "Toggles virtual whitespace for all files.", 41, "D:\\work\\4ed\\code\\custom\\4coder_code_index.cpp", 45, 1689 },
...
static i32 fcoder_metacmd_ID_luis_startup = 131;
static i32 fcoder_metacmd_ID_luis_toggle_modal_mode = 132;
static i32 fcoder_metacmd_ID_luis_view_input_handler = 133;
static i32 fcoder_metacmd_ID_luis_write_newline = 134;
static i32 fcoder_metacmd_ID_luis_write_pointer_arrow = 135;
static i32 fcoder_metacmd_ID_luis_write_tab = 136;
static i32 fcoder_metacmd_ID_luis_write_underscore = 137;
static i32 fcoder_metacmd_ID_make_directory_query = 138;
static i32 fcoder_metacmd_ID_miblo_decrement_basic = 139;
static i32 fcoder_metacmd_ID_miblo_decrement_time_stamp = 140;
static i32 fcoder_metacmd_ID_miblo_decrement_time_stamp_minute = 141;
static i32 fcoder_metacmd_ID_miblo_increment_basic = 142;
static i32 fcoder_metacmd_ID_miblo_increment_time_stamp = 143;
static i32 fcoder_metacmd_ID_miblo_increment_time_stamp_minute = 144;
static i32 fcoder_metacmd_ID_mouse_wheel_change_face_size = 145;
static i32 fcoder_metacmd_ID_mouse_wheel_scroll = 146;
static i32 fcoder_metacmd_ID_move_down = 147;
static i32 fcoder_metacmd_ID_move_down_10 = 148;
static i32 fcoder_metacmd_ID_move_down_textual = 149;
static i32 fcoder_metacmd_ID_move_down_to_blank_line = 150;
static i32 fcoder_metacmd_ID_move_down_to_blank_line_end = 151;
static i32 fcoder_metacmd_ID_move_down_to_blank_line_skip_whitespace = 152;
static i32 fcoder_metacmd_ID_move_left = 153;
static i32 fcoder_metacmd_ID_move_left_alpha_numeric_boundary = 154;
static i32 fcoder_metacmd_ID_move_left_alpha_numeric_or_camel_boundary = 155;
static i32 fcoder_metacmd_ID_move_left_token_boundary = 156;
static i32 fcoder_metacmd_ID_move_left_whitespace_boundary = 157;
static i32 fcoder_metacmd_ID_move_left_whitespace_or_token_boundary = 158;
static i32 fcoder_metacmd_ID_move_line_down = 159;
static i32 fcoder_metacmd_ID_move_line_up = 160;
static i32 fcoder_metacmd_ID_move_right = 161;
static i32 fcoder_metacmd_ID_move_right_alpha_numeric_boundary = 162;
static i32 fcoder_metacmd_ID_move_right_alpha_numeric_or_camel_boundary = 163;
static i32 fcoder_metacmd_ID_move_right_token_boundary = 164;
static i32 fcoder_metacmd_ID_move_right_whitespace_boundary = 165;
static i32 fcoder_metacmd_ID_move_right_whitespace_or_token_boundary = 166;
static i32 fcoder_metacmd_ID_move_up = 167;
static i32 fcoder_metacmd_ID_move_up_10 = 168;
static i32 fcoder_metacmd_ID_move_up_to_blank_line = 169;
static i32 fcoder_metacmd_ID_move_up_to_blank_line_end = 170;
static i32 fcoder_metacmd_ID_move_up_to_blank_line_skip_whitespace = 171;
static i32 fcoder_metacmd_ID_multi_paste = 172;
static i32 fcoder_metacmd_ID_multi_paste_interactive = 173;
static i32 fcoder_metacmd_ID_multi_paste_interactive_quick = 174;
static i32 fcoder_metacmd_ID_music_start = 175;
static i32 fcoder_metacmd_ID_music_stop = 176;
static i32 fcoder_metacmd_ID_open_all_code = 177;
static i32 fcoder_metacmd_ID_open_all_code_recursive = 178;
static i32 fcoder_metacmd_ID_open_file_in_quotes = 179;
static i32 fcoder_metacmd_ID_open_in_other = 180;
static i32 fcoder_metacmd_ID_open_long_braces = 181;
static i32 fcoder_metacmd_ID_open_long_braces_break = 182;
static i32 fcoder_metacmd_ID_open_long_braces_semicolon = 183;
static i32 fcoder_metacmd_ID_open_matching_file_cpp = 184;
static i32 fcoder_metacmd_ID_open_panel_hsplit = 185;
static i32 fcoder_metacmd_ID_open_panel_vsplit = 186;
static i32 fcoder_metacmd_ID_page_down = 187;
static i32 fcoder_metacmd_ID_page_up = 188;
static i32 fcoder_metacmd_ID_paste = 189;
static i32 fcoder_metacmd_ID_paste_and_indent = 190;
static i32 fcoder_metacmd_ID_paste_next = 191;
static i32 fcoder_metacmd_ID_paste_next_and_indent = 192;
static i32 fcoder_metacmd_ID_place_in_scope = 193;
static i32 fcoder_metacmd_ID_play_with_a_counter = 194;
static i32 fcoder_metacmd_ID_profile_clear = 195;
static i32 fcoder_metacmd_ID_profile_disable = 196;
static i32 fcoder_metacmd_ID_profile_enable = 197;
static i32 fcoder_metacmd_ID_profile_inspect = 198;
static i32 fcoder_metacmd_ID_project_command_F1 = 199;
static i32 fcoder_metacmd_ID_project_command_F10 = 200;
static i32 fcoder_metacmd_ID_project_command_F11 = 201;
static i32 fcoder_metacmd_ID_project_command_F12 = 202;
static i32 fcoder_metacmd_ID_project_command_F13 = 203;
static i32 fcoder_metacmd_ID_project_command_F14 = 204;
static i32 fcoder_metacmd_ID_project_command_F15 = 205;
static i32 fcoder_metacmd_ID_project_command_F16 = 206;
static i32 fcoder_metacmd_ID_project_command_F2 = 207;
static i32 fcoder_metacmd_ID_project_command_F3 = 208;
static i32 fcoder_metacmd_ID_project_command_F4 = 209;
static i32 fcoder_metacmd_ID_project_command_F5 = 210;
static i32 fcoder_metacmd_ID_project_command_F6 = 211;
static i32 fcoder_metacmd_ID_project_command_F7 = 212;
static i32 fcoder_metacmd_ID_project_command_F8 = 213;
static i32 fcoder_metacmd_ID_project_command_F9 = 214;
static i32 fcoder_metacmd_ID_project_command_lister = 215;
static i32 fcoder_metacmd_ID_project_fkey_command = 216;
static i32 fcoder_metacmd_ID_project_go_to_root_directory = 217;
static i32 fcoder_metacmd_ID_project_reprint = 218;
...
static i32 fcoder_metacmd_ID_rename_file_query = 225;
static i32 fcoder_metacmd_ID_reopen = 226;
static i32 fcoder_metacmd_ID_replace_in_all_buffers = 227;
static i32 fcoder_metacmd_ID_replace_in_buffer = 228;
static i32 fcoder_metacmd_ID_replace_in_range = 229;
static i32 fcoder_metacmd_ID_reverse_search = 230;
static i32 fcoder_metacmd_ID_reverse_search_identifier = 231;
...
static i32 fcoder_metacmd_ID_tutorial_maximize = 284;
static i32 fcoder_metacmd_ID_tutorial_minimize = 285;
static i32 fcoder_metacmd_ID_uncomment_line = 286;
static i32 fcoder_metacmd_ID_undo = 287;
static i32 fcoder_metacmd_ID_undo_all_buffers = 288;
static i32 fcoder_metacmd_ID_view_buffer_other_panel = 289;
static i32 fcoder_metacmd_ID_view_jump_list_with_lister = 290;
static i32 fcoder_metacmd_ID_vim_command_mode = 291;
static i32 fcoder_metacmd_ID_vim_interactive_open_or_new = 292;
static i32 fcoder_metacmd_ID_vim_list_all_functions_current_buffer_lister = 293;
static i32 fcoder_metacmd_ID_vim_proj_cmd_lister = 294;
static i32 fcoder_metacmd_ID_vim_switch_lister = 295;
static i32 fcoder_metacmd_ID_vim_theme_lister = 296;
static i32 fcoder_metacmd_ID_word_complete = 297;
static i32 fcoder_metacmd_ID_word_complete_drop_down = 298;
static i32 fcoder_metacmd_ID_write_block = 299;
static i32 fcoder_metacmd_ID_write_hack = 300;
static i32 fcoder_metacmd_ID_write_note = 301;
static i32 fcoder_metacmd_ID_write_space = 302;
static i32 fcoder_metacmd_ID_write_text_and_auto_indent = 303;
static i32 fcoder_metacmd_ID_write_text_input = 304;
static i32 fcoder_metacmd_ID_write_todo = 305;
static i32 fcoder_metacmd_ID_write_underscore = 306;
static i32 fcoder_metacmd_ID_write_zero_struct = 307;
#endif
