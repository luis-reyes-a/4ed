...
#undef M
    ...
    if (dynamic_binding_load_from_file(app, &framework_mapping, bindings_file_name)){
        setup_essential_mapping(&framework_mapping, global_map_id, file_map_id, code_map_id); //isn't this called twice? Or is it suppoed to be called always after dynamic_binding_load_from_file
    }
    else{
